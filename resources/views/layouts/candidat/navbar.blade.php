<nav
    ...
    >
        ...
        >
            ...
            >
                Votre code d'instructeur : {{session('code_instr')}}&nbsp;&nbsp;
            </li>
            <!-- Language -->
            <li
                class="nav-item dropdown-language dropdown me-2 me-xl-0"
            ...
            >
                ...
                >
                    <div class="avatar avatar-online">
                        @php
                            $photoUrl = null;
                            if (session('candidat_photo')) {
                                $photoUrl = 'https://www.zengymhealth.com/zen_gym_ws/project/storage/app/public/' . session('candidat_photo');
                            }
                        @endphp
                        <img src="{{ $photoUrl ?? 'https://icons.iconarchive.com/icons/iconshock/real-vista-general/256/administrator-icon.png' }}"
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        >
                            <div class="d-flex">
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            src="{{ $photoUrl ?? 'https://icons.iconarchive.com/icons/iconshock/real-vista-general/256/administrator-icon.png' }}"
                                            alt
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route("candidat.profile") }}">
