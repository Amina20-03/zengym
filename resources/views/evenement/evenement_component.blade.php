        ...
        $(document).ready(function() {
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex) {
                    ...
                    var startTime = data[2]; // Use data for the start time column
                    ...
                    var salary = parseFloat(data[7].replace(/[\$,]/g, '')) || 0; // Use data for the salary column
