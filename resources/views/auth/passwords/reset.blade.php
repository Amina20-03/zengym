    ...
    <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
            <div class="w-px-400 mx-auto">
                ...
                <p class="mb-4">Votre nouveau mot de passe doit être différent des précédents.</p>
                ...
                @if($errors->any())
                    <div class="alert alert-danger alert-dismissible mb-3">
                        @foreach($errors->all() as $error)
                            @php
                                $msg = $error;
                                if (str_contains($error, 'validation.min.string') || str_contains($error, 'min.string')) {
                                    $msg = 'Le mot de passe doit contenir au minimum 8 caractères.';
                                } elseif (str_contains($error, 'validation.confirmed') || str_contains($error, 'confirmed')) {
                                    $msg = 'La confirmation du mot de passe ne correspond pas.';
                                } elseif (str_contains($error, 'validation.email') || str_contains($error, '.email')) {
                                    $msg = 'L\'adresse email n\'est pas valide.';
                                } elseif (str_contains($error, 'passwords.token')) {
                                    $msg = 'Ce lien de réinitialisation est invalide ou expiré.';
                                } elseif (str_contains($error, 'passwords.user')) {
                    ...
                    <div class="mb-3 form-password-toggle">
                        ...
                        @error('password')
                            <div class="text-danger small mt-1">
                                ...
                                @elseif(str_contains($message, 'confirmed'))
