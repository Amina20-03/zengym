...
<section id="landingContact" class="section-py bg-body">
    <div class="container" style="margin-top: 100px">
        ...
        <h3 class="text-center mb-1">
            <span class="section-title">Trouver</span> des cours
        </h3>
        <p class="text-center mb-4 mb-lg-5 pb-md-3">Trouvez des cours selon vos besoins</p>
        <div class="row">
            <div class="col-md-5">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">{{ __('content.Liste_categorie') }}</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-7">
                ...
                <div class="col-md-12 col-xl-12 mb-12">
                    <div class="card h-100">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title m-0 me-2">{{ __('content.cours') }} {{$detail_cat[0]['titre']}}</h5>
                            {{--                    <div class="dropdown">--}}
                        ...
                        <div class="card-body">
                            ...
                            >
                                ...
                                <tr>
                                    <th hidden>Date</th>
                                    <th hidden>heure deb</th>
                                    <th hidden></th>
                                    <th hidden></th>
                                    <th hidden>instructeur</th>
                                    <th hidden>Frais</th>
                                    <th hidden></th>
                                    <th hidden>emplacement</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50px">
                                                <div>
                                                    ...
                                                    <small class="text-muted">{{$elem['hdeb']}} ({{round(abs($from_time - $to_time) / 60,2)}} minutes)</small>


                                                </div>
                                            </td>
                                            <td style="width: 50px">
                                                <div class="avatar flex-shrink-0 me-3 border-start border-light">
                                                    @php
                                                    ...
                                                    @endphp
                                                    <img src="{{ $photo }}" alt="Instructeur" class="rounded ms-3">
                                                </div>

                                            </td>
                                            <td>
                                                <div class="border-end border-light p-2">
                                                    <small class="text-muted">{{ $elem['instructeur'][0]['profession'] ?? '' }}</small>
                                                    <h6 class="mb-0">
                                                        {{ $elem['instructeur_user'][0]['nom'] ?? '' }} {{ $elem['instructeur_user'][0]['prenom'] ?? '' }}
                                                    </h6>
                                                    <small class="text-muted">{{ $elem['instructeur_categ'] ?? '' }}</small>
                                                </div>
                                            ...
                                            <td style="width: 50px">
                                                <div>
                                                    @if($elem['date'] > date('Y-m-d'))
                                                        <a href="{{route('login')}}" class="btn btn-sm btn-icon" style="background-color: lightgray; width:100%;padding:15px; margin-bottom: 5px">
