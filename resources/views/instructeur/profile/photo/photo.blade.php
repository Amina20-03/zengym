        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex flex-wrap justify-content-between gap-3">
                                <div class="card-title mb-0 me-1">
                                    <h5 class="mb-1">{{ __('content.mes_photos') }}</h5>
                                        ...
                                        <div class="card p-2 h-100 shadow-none border">
                                            <a href="#"  class="me-sm-3 me-1 data-submit"
                                               data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser">
                                                <img class="img-fluid" src="https://cdn-icons-png.freepik.com/256/8467/8467062.png?semt=ais_hybrid" style="padding: 30px;width: 100%"/>

                                            </a>
                                        </div>
                                    </div>
                                    @if(count($liste_photos)>0)
                                        @foreach($liste_photos as $elem)
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="card p-2 h-100 shadow-none border">
                                                    <div class="rounded-2 text-center mb-3">
                                                        <a href="#">
                                                            @if($elem['photo'])
                                                                <img class="img-fluid" src="data:image/jpg;base64,{{$elem['photo'] }}" alt="tutor image 1" style="width: 285px"/>

                                                            @else
                                                                <img class="img-fluid" src="https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTEyL3dvcmxkZmFjZXNsYWJfc2lnbl9vZl9wYXN0ZWxfbmVvbl9jYW1lcmFfbGluZV9pY29uX2luX3N0eWxlX29mX180ZDA3MzJhMC0yMDI4LTQ2YWItOGFlNC01YmIxNjY5M2M5N2RfMS5qcGc.jpg" alt="tutor image 1" />
                                                            @endif
                                                        </a>
                                                    </div>
                    ...
                    <form method="POST" action="{{route('instructeur.profile.photos.delete')}}" class="add-new-user pt-0">
                        @csrf
                        @include('layouts.delete_modal')

                    </form>
                    <form method="POST" action="{{route('instructeur.profile.photos.search')}}" id="search_photo_form" class="add-new-user pt-0">
                        @csrf
                        @include('layouts.delete_modal')
                    ...
                    >
                        ...
                        >
                            ...
                            <form method="POST" enctype="multipart/form-data" id="addNewUserForm" action="{{ route('instructeur.profile.photos.add') }}" class="row g-3">
                                @csrf
                                <div class="mb-3">
                        ...
                        <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                            <h1 class="modal-content p-3 p-md-5">
                                <div class="modal-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="{{route('instructeur.profile.photos.categ.add')}}" class="row g-3">
                                        @csrf
