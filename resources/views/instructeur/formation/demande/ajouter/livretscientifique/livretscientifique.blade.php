            ...
            <div class="content-wrapper" style="margin-top: -100px">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row">
                        ...
                        <!--/ Navbar pills -->
                        @if($categ_formation_id == '1' || $categ_formation_id == '2')
                        <form method="post" id="addNewUserForm" action="{{ route('instructeur.demande_formation.create.media.prog_de_formation') }}" enctype="multipart/form-data"  class="row g-3">
                        @endif
                        @if($categ_formation_id == '3')
                            <form method="post" id="addNewUserForm" action="{{ route('instructeur.demande_formation.create.media.presentation_power_point') }}" enctype="multipart/form-data"  class="row g-3">
                        @endif
                                ...
                                <div class="col-xl-12 col-lg-5 col-md-5">
                                    ...
                                    <div class="card mb-6">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-12" style="margin-top: 150px;margin-bottom: 150px">
                                                    <div class="container">
                                                        <label for="et_pb_contact_brand_file_request_0" class="et_pb_contact_form_label">Enter</label>
                                                        <input type="file" id="et_pb_contact_brand_file_request_0" class="file-upload" name="docs">
                                                    </div>
                                                </div>
