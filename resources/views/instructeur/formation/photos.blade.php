                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            ...
                            <form method="post" id="addNewUserForm" action="{{ route('instructeur.formation.photos.add',$detail['id']) }}" enctype="multipart/form-data"  class="row g-3">
                                @csrf
                                                ...
                                                <div class="row" style="margin-top: 10px">
                                                    @foreach($detail['photos'] as $photo)
                                                        <div class="col-3 col-md-3">
                                                            ...
                                                            <a href="{{route('instructeur.formation.photos.delete_photo',$photo['id'])}}" class="btn btn-irv" style=" background: red;color: white;width:100%;">
