<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.instructeur.menu',['menuprincipaleactive' =>'cours','menuactive' =>'liste_cours'])
    ...
    @if($elem['approuver'])
        @if(!$elem['realiser'])
            @if($elem['date'] < date('Y-m-d'))
                <form action="{{ route('instructeur.cours.realiser', $elem['id']) }}" method="POST" style="margin-bottom: 5px;">
                    @csrf
                    <button type="submit" class="btn btn-sm btn-icon" style="background-color: lightgray; width:100%;padding:15px; border:none;">
    ...
    @endif
                ...
                <form method="POST" action="{{route('instructeur.cours.delete')}}" class="add-new-user pt-0">
                    @csrf
