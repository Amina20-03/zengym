...
<head>
    ...
    <style>
        ...
        .example-slider .fnc-slide-1 .fnc-slide__mask-inner {
            background-image: url("{{\Illuminate\Support\Facades\URL::asset('images/devenir_franchise_affiche_zengym.png')}}");
        }
            ...
            <div class="fnc-slide m--blend-dark m--active-slide">
                <div class="fnc-slide__inner">
                    ...
                    <div class="fnc-slide__content">
                        ...
                        <a href="{{route('rejoignez_nous.devenir_representant')}}" target="_parent" type="button" class="fnc-slide__action-btn">
                            Rejoignez maintenant
                            <span data-text="Voir plus">Rejoignez maintenant</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="fnc-slide m--blend-red">
                <div class="fnc-slide__inner">
                    ...
                    <div class="fnc-slide__content">
                        ...
                        <a href="{{route('rejoignez_nous.devenir_franchise')}}" target="_parent" type="button" class="fnc-slide__action-btn">
                            Rejoignez maintenant
                            <span data-text="Voir plus">Rejoignez maintenant</span>
                        </a>
                    </div>
            ...
            <div class="fnc-slide m--blend-green">
                <div class="fnc-slide__inner">
                    ...
                    <div class="fnc-slide__content">
                        ...
                        <a href="{{route('rejoignez_nous.devenir_instructeur')}}" target="_parent" type="button" class="fnc-slide__action-btn">
                            Rejoignez maintenant
                            <span data-text="Voir plus">Rejoignez maintenant</span>
                        </a>
                    </div>
