...
<main>
    <h2 class="title">
        <?php
        echo html_entity_decode(__('content.Comment devenir Franchisé ZENGYM ?'));
        ?>
    </h2>
    <ul class="infoGraphic">
        <li>
            ...
            <div class="content">
                <div class="icon">
                    <img src="{{\Illuminate\Support\Facades\URL::asset('icons/Capture13.png')}}" style="width: 40px">
                </div>
                <h2>
                    <?php
                    echo html_entity_decode(__('content.Contrat avec ZENGYM'));
                    ?>
                </h2>
                <p>
                    <?php
                    echo html_entity_decode(__('content.Prendre contrat avec ZENGYM'));
                    ?>
                </p>
            </div>
        </li>
        <li>
            ...
            <div class="content">
                <div class="icon">
                    <img src="{{\Illuminate\Support\Facades\URL::asset('icons/Capture14.png')}}" style="width: 50px">
                </div>
                <h2>
                    <?php
                ...
                <p>
                    <?php
                    echo html_entity_decode(__('content.Signer un contrat de franchise'));
                    ?>
                </p>
            </div>
        </li>
        <li>
            ...
            <div class="content">
                <div class="icon">
                    <img src="{{\Illuminate\Support\Facades\URL::asset('icons/Capture15.png')}}" style="width: 40px">
                </div>
                <h2>
                    <?php
                    echo html_entity_decode(__('content.Formation ZENGYM'));
                    ?>
                </h2>
                <p>
                    <?php
                    echo html_entity_decode(__('content.Formation complète ZENGYM'));
                    ?>
                </p>
            </div>
        </li>
        <li>
            ...
            <div class="content">
                <div class="icon">
                    <img src="{{\Illuminate\Support\Facades\URL::asset('icons/Capture16.png')}}" style="width: 45px">
                </div>
                <h2>
                    <?php
                    echo html_entity_decode(__('content.Lancement du studio'));
                    ?>
                </h2>
                <p>
                    <?php
                    echo html_entity_decode(__('content.Aménagement et lancement du studio'));
                    ?>
                </p>
            </div>
        </li>
        <li>
            ...
            <div class="content">
                <div class="icon">
                    <img src="{{\Illuminate\Support\Facades\URL::asset('icons/Capture17.png')}}" style="width: 40px">
                </div>
                <h2>
                    <?php
                    echo html_entity_decode(__('content.Accompagnment continue'));
                    ?>
                </h2>
                <p>
                    <?php
                    echo html_entity_decode(__('content.Accompagnment & croissance continue'));
                    ?>
                </p>
            </div>
        </li>
...
<div class="controls">
    <div class="sliderBox">
        <img src="{{\Illuminate\Support\Facades\URL::asset('images/image14.png')}}" style="width: 50%">
    </div>
</div>
{{--<div class="controls">--}}
{{--    <div class="sliderBox">--}}
