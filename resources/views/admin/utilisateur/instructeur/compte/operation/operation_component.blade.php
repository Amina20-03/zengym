...
@section('content')
    @include('admin.utilisateur.instructeur.compte.operation.operation')
@endsection
@section('datatable')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function myFunction() {
                var solde = parseFloat($('#global_sum').val()) ;
                var montant =parseFloat($('#montant').val()) ;
                if(montant>solde){
                    alert('{{ __('content.solde_insufissant') }}');
                }
                else{
                    ...
                    "buttons": [
                        {
                            ...
                            title:'{{ __('content.les_operations') }}',
                            titleAttr: 'Copier',
