<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.admin.menu',['menuprincipaleactive' =>'vente_abonnement','menuactive' =>'list_abo'])
...
{{--                                                </a>--}}
                ...
                <form method="POST" action="{{route('admin.vente_abo.delete')}}" class="add-new-user pt-0">
                    @csrf
