                            ...
                            <div class="col-md-12">
                                <div class="nav-align-top">
                                    <ul class="nav nav-pills flex-column flex-sm-row mb-6">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='bx bx-grid-alt bx-sm me-1_5'></i> {{ __('content.video') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card academy-content shadow-none border">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('admin.evenement.details.videos.add',$detail['id']) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="file" name="videos[]" multiple class="form-control mb-3">
                                            ...
                                            <div class="row">
                                                @foreach($detail_videos as $video)
                                                    ...
                                                    <div class="col-md-2 mb-2">
                                                        ...
                                                        <a href="{{route('admin.evenement.details.videos.delete',$video['id'])}}" class="btn btn-danger">
                                                            X
                                                        </a>
                                                    </div>
                                                @endforeach
