<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.admin.menu',['menuprincipaleactive' =>'Paramétrage','menuactive' =>'categorie_representant'])
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                                ...
                                <div class="card" style="padding:10px">
                                    <div class="row row-bordered g-0">
                                                ...
                                                <div class="card-datatable table-responsive">
                                                    ...
                                                    >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="text-align:center">{{ __('content.categorie_representant') }}</th>
                                                            ...
                                                            @foreach($liste as $elem)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        ...
                                                                        <a href="{{route('admin.categorie_representant.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                                        ...
                                        <div class="col-md-2" style="padding: 10px;display: grid;">
                                            ...
                                            <div>
                                                <form method="POST" id="addNewUserForm" action="{{ route('admin.categorie_representant.add') }}" class="row g-3">
                                                    @csrf
                                                    ...
                                                    <div class="mb-3">
                                                        <label
                                                            class="form-label"
                                                            for="desc"
                                                        >{{ __('content.categorie_representant') }}</label
                                                        >
                                                        <input
                                                            type="text"
                                                            class="form-control"
                                                            id="desc"
                                                            placeholder="{{ __('content.categorie_representant') }}"
                                                            name="desc"
                                                            aria-label="{{ __('content.categorie_representant') }}"
                                                        />
                                                    </div>
                                            ...
                                            >
                                                {{count($liste)}} {{ __('content.categorie_representant') }}
                                            </div>
                ...
                <form method="POST" action="{{route('admin.categorie_representant.delete')}}" class="add-new-user pt-0">
                    @csrf
