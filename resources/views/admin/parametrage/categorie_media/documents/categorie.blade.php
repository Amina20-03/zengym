    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper" style="margin-top: -90px">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                                <li class="nav-item"><a class="nav-link" href="{{route('admin.categorie_media.photos.index')}}"><i class='fa fa-picture-o me-1'></i> {{ __('content.photos') }}</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('admin.categorie_media.videos.index')}}"><i class='fa fa-video-camera me-1'></i> {{ __('content.video') }}</a></li>
                                <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='fa fa-files-o me-1'></i> {{ __('content.document') }}</a></li>
                            </ul>
                        </div>
                    </div>
                    <!--/ Navbar pills -->
                        ...
                        <div class="card" style="padding:10px">
                            <div class="row row-bordered g-0">
                                        ...
                                        <div class="card-datatable table-responsive">
                                            ...
                                            >
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align:center">{{ __('content.categorie_document') }}</th>
                                                    ...
                                                    @foreach($liste as $elem)
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                ...
                                                                <a href="{{route('admin.categorie_media.documents.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                                ...
                                <div class="col-md-2" style="padding: 10px;display: grid;">
                                    ...
                                    <div>
                                        <form method="POST" id="addNewUserForm" action="{{ route('admin.categorie_media.documents.add') }}" class="row g-3">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                <label
                                                    class="form-label"
                                                    for="desc"
                                                >{{ __('content.categorie_document') }}</label
                                                >
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="desc"
                                                    placeholder="{{ __('content.categorie_document') }}"
                                                    name="desc"
                                                    aria-label="{{ __('content.categorie_document') }}"
                                                />
                                            </div>
                                    ...
                                    >
                                        {{count($liste)}} {{ __('content.categorie_document') }}
                                    </div>
                ...
                <form method="POST" action="{{route('admin.categorie_media.documents.delete')}}" class="add-new-user pt-0">
                    @csrf
