                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="{{route('admin.categorie_media.videos.index')}}"><i class='fa fa-video-camera me-1'></i> {{ __('content.video') }}</a></li>
                            ...
                            <div class="card mb-12">
                                <div class="card-body">
                                    <div class="user-avatar-section">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >{{ __('content.categorie_video') }}</span
                                                >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-container">
                                        <form method="POST" id="editUserForm" action="{{ route('admin.categorie_media.videos.update',$detail[0]['id']) }}" class="row g-3">
                                            @csrf
