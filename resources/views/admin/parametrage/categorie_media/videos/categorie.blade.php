    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper" style="margin-top: -90px">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='fa fa-video-camera me-1'></i> {{ __('content.video') }}</a></li>
                        ...
                        <div class="card" style="padding:10px">
                            <div class="row row-bordered g-0">
                                        ...
                                        <div class="card-datatable table-responsive">
                                            ...
                                            >
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align:center">{{ __('content.categorie_video') }}</th>
                                                    ...
                                                    @foreach($liste as $elem)
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                ...
                                                                <a href="{{route('admin.categorie_media.videos.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                                ...
                                <div class="col-md-2" style="padding: 10px;display: grid;">
                                    ...
                                    <div>
                                        <form method="POST" id="addNewUserForm" action="{{ route('admin.categorie_media.videos.add') }}" class="row g-3">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                <label
                                                    class="form-label"
                                                    for="desc"
                                                >{{ __('content.categorie_video') }}</label
                                                >
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="desc"
                                                    placeholder="{{ __('content.categorie_video') }}"
                                                    name="desc"
                                                    aria-label="{{ __('content.categorie_video') }}"
                                                />
                                            </div>
                                    ...
                                    >
                                        {{count($liste)}} {{ __('content.categorie_video') }}
                                    </div>
                ...
                <form method="POST" action="{{route('admin.categorie_media.videos.delete')}}" class="add-new-user pt-0">
                    @csrf
