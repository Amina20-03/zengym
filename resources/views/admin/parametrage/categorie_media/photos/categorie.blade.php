    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper" style="margin-top: -90px">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                                <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='fa fa-picture-o me-1'></i> {{ __('content.photos') }}</a></li>
                        ...
                        <div class="card" style="padding:10px">
                            <div class="row row-bordered g-0">
                                        ...
                                        <div class="card-datatable table-responsive">
                                            ...
                                            >
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align:center">{{ __('content.categorie_photo') }}</th>
                                                    ...
                                                    @foreach($liste as $elem)
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                ...
                                                                <a href="{{route('admin.categorie_media.photos.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                                ...
                                <div class="col-md-2" style="padding: 10px;display: grid;">
                                    ...
                                    <div>
                                        <form method="POST" id="addNewUserForm" action="{{ route('admin.categorie_media.photos.add') }}" class="row g-3">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input
                                                    ...
                                                    class="form-control"
                                                    id="desc"
                                                    placeholder="{{ __('content.categorie_photo') }}"
                                                    name="desc"
                                                    aria-label="{{ __('content.categorie_photo') }}"
                                                />
                                            </div>
                                    ...
                                    >
                                        {{count($liste)}} {{ __('content.categorie_photo') }}
                                    </div>
                ...
                <form method="POST" action="{{route('admin.categorie_media.photos.delete')}}" class="add-new-user pt-0">
                    @csrf
