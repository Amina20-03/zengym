<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.admin.menu',['menuprincipaleactive' =>'vente_abonnement_adherent','menuactive' =>'categ_abo_adherent'])
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="card" style="padding:10px">
                            <div class="row row-bordered g-0">
                                                    ...
                                                    @foreach($liste as $elem)
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                ...
                                                                <a href="{{route('admin.abo.adherent.categ_abo.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                                ...
                                <div class="col-md-2" style="padding: 10px;display: grid;">
                                    ...
                                    <div>
                                        <form method="POST" enctype="multipart/form-data" id="addNewUserForm" action="{{ route('admin.abo.adherent.categ_abo.add') }}" class="row g-3">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label
                                                    class="form-label"
                                                    for="desc"
                                                >{{ __('content.categ_abo') }}</label
                                                >
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    id="desc"
                                                    placeholder="{{ __('content.categ_abo') }}"
                                                    name="desc"
                                                    aria-label="{{ __('content.categ_abo') }}"
                                                />
                                            </div>
                                    ...
                                    >
                                        {{count($liste)}} {{ __('content.categ_abo') }}
                                    </div>
                ...
                <form method="POST" action="{{route('admin.abo.adherent.categ_abo.delete')}}" class="add-new-user pt-0">
                    @csrf
