                            ...
                            <div class="card mb-12">
                                <div class="card-body">
                                    ...
                                    <div class="info-container">
                                        <form method="POST" enctype="multipart/form-data" id="editUserForm" action="{{ route('admin.abo.adherent.categ_abo.update',$detail[0]['id']) }}" class="row g-3">
                                            @csrf
