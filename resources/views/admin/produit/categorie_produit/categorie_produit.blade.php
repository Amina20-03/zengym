<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.admin.menu',['menuprincipaleactive' =>'produits','menuactive' =>'categ_produit'])
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="card" style="padding:10px">
                            <div class="row row-bordered g-0">
                                <div class="col-md-12" style="padding: 10px;display: grid;">
                                    ...
                                    <div>
                                        <form method="POST" id="addNewUserForm" action="{{ route('admin.categorie_produit.add') }}" class="row g-3">
                                            @csrf
                                    ...
                                    >
                                        {{count($liste)}} {{ __('content.categ_produit') }}
                                    </div>
                                                    ...
                                                    @foreach($liste as $elem)
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                ...
                                                                <a href="{{route('admin.categorie_produit.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                ...
                <form method="POST" action="{{route('admin.categorie_produit.delete')}}" class="add-new-user pt-0">
                    @csrf
