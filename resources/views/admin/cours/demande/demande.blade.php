                                ...
                                @if(count($liste)>0)
                                    @foreach($liste as $elem)
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                {{$elem['instructeur_user'][0]['nom']}}
                                                {{$elem['instructeur_user'][0]['prenom']}}
                                            </td>
                                            <td style="text-align:center">
                                                {{$elem['code']}}
                                            </td>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <a href="{{route('admin.demande_cours.details',$elem['id'])}}" class="btn btn-sm btn-icon" style="background-color: lightgray; width:100%;padding:15px; margin-bottom: 5px">
