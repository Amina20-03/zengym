<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.admin.menu',['menuprincipaleactive' =>'candidats','menuactive' =>'categ_candidat'])
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="card" style="padding:10px">
                            <div class="row row-bordered g-0">
                                <div class="col-md-12" style="padding: 10px;display: grid;">
                                    ...
                                    <div>
                                        <form method="POST" id="addNewUserForm" action="{{ route('admin.categ_candidat.add') }}" class="row g-3">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                <label
                                                        class="form-label"
                                                        for="titre"
                                                >{{ __('content.categ_candidat') }}</label
                                                >
                                                <input
                                                        type="text"
                                                        class="form-control"
                                                        id="titre"
                                                        placeholder="{{ __('content.categ_candidat') }}"
                                                        name="titre"
                                                        aria-label="{{ __('content.categ_candidat') }}"
                                                />
                                            </div>
                                            <div class="mb-3">
                                                <label
                                    ...
                                    >
                                        {{count($liste)}} {{ __('content.categ_candidat') }}
                                    </div>
                                        ...
                                        <div class="card-datatable table-responsive">
                                            ...
                                            >
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align:center">{{ __('content.libelle') }}</th>
                                                    ...
                                                    @foreach($liste as $elem)
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                ...
                                                                <a href="{{route('admin.categ_candidat.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                ...
                <form method="POST" action="{{route('admin.categ_candidat.delete')}}" class="add-new-user pt-0">
                    @csrf
