            ...
            <div class="content-wrapper">
                                    ...
                                    @foreach($liste as $elem)
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <a href="{{route('admin.candidat.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                                                    <img src="https://icons.veryicon.com/png/o/miscellaneous/blue-soft-fillet-icon/edit-173.png" alt="" style="width:100%;">
                                                </a>
                                                <a href="{{route('admin.candidat.passage_vers_instructeur.form',$elem['id'])}}" class="btn btn-sm btn-icon">
                                                    <img src="https://cdn-icons-png.flaticon.com/512/10382/10382380.png" alt="" style="width:100%;">
                                                </a>
                ...
                >
                    ...
                    >
                        ...
                        <form method="POST" id="addNewUserForm" action="{{ route('admin.candidat.add') }}" class="row g-3">
                            @csrf
                            <div class="mb-3">
