...
@section('content')
    @include('admin.stock_vente.bon_sortie.bon_sortie')
@endsection
@section('datatable')
    <script>
        function fillTable() {
            ...
            $("#table tbody").find('input[name="record"]').each(function(){
                if($(this).is(":checked")){
                    ...
                    if($(this).val() === '{{$liste_ligne_be[$i]['IDBSORTIE']}}'){
                        @php
                        ...
                        var markup = '<tr>' +
                            ...
                            ' </td>' +
                            ' <td style="text-align:center">' +
                            ' {{$liste_ligne_be[$i]['qte_sortie']}}' +
                            ' </td>' +
                            ' <td style="text-align:center">' +
                            ' {{$liste_ligne_be[$i]['pu_sortie']}}' +
                            ' </td>' +
                            ' <td style="text-align:center">' +
                            ' {{$liste_ligne_be[$i]['total_ligne_st']}}' +
                            ' </td>' +
                    ...
                    "buttons": [
                        {
                            ...
                            title:'{{ __('content.Liste_bon_sortie') }}',
                            titleAttr: 'Copier',
