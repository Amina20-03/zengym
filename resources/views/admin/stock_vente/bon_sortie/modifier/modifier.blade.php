                            ...
                            <div class="card mb-12">
                                <div class="card-body">
                                    ...
                                    <div class="info-container">
                                        <form method="POST" id="add_bon_en_form" action="{{route('admin.stock_vente.bon_sortie.update',$detail[0]['id'])}}" class="row g-3">
                                            @csrf
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <input
                                                    ...
                                                    name="date_bs"
                                                    class="form-control"
                                                    value="{{$detail[0]['date_bs'] ?? date('Y-m-d')}}"
                                                />
                                            </div>
