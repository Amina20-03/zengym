...
@section('content')
    @include('admin.stock_vente.bon_sortie.modifier.modifier')
@endsection
@section('datatable')
    <script>
        function calcul_total(id) {
            ...
            var inputInputPU = $("#table_prod tbody").find('input[id="pu_prod_entree_table'+id+'"]');
            var inputIntotal = $("#table_prod tbody").find('input[id="total_ligne_entree_table'+id+'"]');

            var qte2 = parseInt(inputInThirdTd.val());
            var pu2 = parseFloat(inputInputPU.val());
            var total2 = pu2 * qte2;


            inputIntotal.val(total2);
            ...
            if(totalCount>0){
                if(occurence_verif(code)){
                    ...
                    var markup = '<tr>' +
                        ...
                        ' </td>' +
                        ' <td style="text-align:center">' +
                        ' <input type="text" name="pu_prod_entree_table" id="pu_prod_entree_table'+IDPROD+'" class="form-control" value="'+pu+'" />' +
                        ' </td>' +
                        ' <td style="text-align:center">' +
                ...
                var markup = '<tr>' +
                    ...
                    ' </td>' +
                    ' <td style="text-align:center">' +
                    ' <input type="text" name="pu_prod_entree_table" id="pu_prod_entree_table'+IDPROD+'" class="form-control" value="'+pu+'" readonly/>' +
                    ' </td>' +
                    ' <td style="text-align:center">' +
                    ' <input type="text" id="total_ligne_entree_table'+IDPROD+'" name="total_ligne_entree_table" class="form-control" value="'+total+'" readonly/>' +
                    ' </td>' +
