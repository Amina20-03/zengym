<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.admin.menu',['menuprincipaleactive' =>'stock_vente','menuactive' =>'bon_entree_add'])
                            ...
                            <div class="card mb-12">
                                <div class="card-body">
                                    ...
                                    <div class="info-container">
                                        <form method="POST" id="add_bon_en_form" action="{{route('admin.stock_vente.bon_entre.add')}}" class="row g-3">
                                            @csrf
