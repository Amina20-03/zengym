    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper" style="margin-top: -60px">
                    ...
                    <div class="card" style="padding: 10px">
                        ...
                        @endif
                            <div class="card-header border-bottom" style="margin-bottom: 20px">
                                ...
                                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.stock_vente.bon_entre.search') }}" class="row g-3">
                                    @csrf
                                    <div
                        ...
                        <div class="card-datatable table-responsive">
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:center">{{ __('content.fournisseur') }}</th>
                                    ...
                                    @foreach($liste as $elem)
                                        <tr>
                                            <td style="text-align:center">
                                                 <input type="radio" name="record" onclick="fillTable()" value="{{$elem['IDBENTREE']}}">
                                            </td>
                                            <td style="text-align:center">
                                                {{$elem['code_be']}}
                                            </td>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <a href="{{route('admin.stock_vente.bon_entre.edit',$elem['IDBENTREE'])}}" class="btn btn-sm btn-icon">
                                                    <img src="https://icons.veryicon.com/png/o/miscellaneous/blue-soft-fillet-icon/edit-173.png" alt="" style="width:100%;">
                                                </a>

                                                <a href="#" class="btn btn-sm btn-icon" onclick="call_delete_modal({{$elem['IDBENTREE']}})" data-bs-toggle="modal" data-bs-target="#onboardImageModal">
                ...
                <form method="POST" action="{{route('admin.stock_vente.bon_entre.delete')}}" class="add-new-user pt-0">
                    @csrf
