    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="card" style="padding:10px">
                            <div class="row row-bordered g-0">
                                <div class="col-md-12" style="padding: 10px;display: grid;">
                                    ...
                                    <div>
                                        <form method="POST" id="addNewUserForm" action="{{ route('admin.categorie_formation.add') }}" class="row g-3">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input
                                                        ...
                                                        class="form-control"
                                                        id="lib"
                                                        placeholder="{{ __('content.categ_formation') }}"
                                                        name="lib"
                                                        aria-label="{{ __('content.categ_formation') }}"
                                                />
                                            </div>
                                            <div class="mb-3">
                                                <label
                                                ...
                                                <input
                                                        ...
                                                        class="form-control"
                                                        id="duree"
                                                        placeholder="{{ __('content.duree') }}"
                                                        name="duree"
                                                        aria-label="{{ __('content.duree') }}"
                                                />
                                            </div>
                                    ...
                                    >
                                        {{count($liste)}} {{ __('content.categ_formation') }}
                                    </div>
                                        ...
                                        <div class="card-datatable table-responsive">
                                            ...
                                            >
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align:center">{{ __('content.categ_formation') }}</th>
                                                    <th style="text-align:center">{{ __('content.duree') }}</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                    ...
                                                                    echo html_entity_decode(
                                                                        \Illuminate\Support\Str::words($elem['desc'], 5)
                                                                    );
                                                                    ?>
                                                            </td>
                                                            <td style="text-align:center">
                                                                ...
                                                                <a href="{{route('admin.categorie_formation.edit',$elem['id'])}}" class="btn btn-sm btn-icon">
                ...
                <form method="POST" action="{{route('admin.categorie_formation.delete')}}" class="add-new-user pt-0">
                    @csrf
