                        ...
                        <div class="card-body row g-3">
                            <div class="col-lg-12">
                                ...
                                <div class="card academy-content shadow-none border">
                                    ...
                                    <div class="card-body">
                                        <embed src="{{ env('APP_URL').'project/storage/app/public/'.$detail[0]['path_prog_de_formation']}}" type="application/pdf" width="100%" height="600px">
                                    </div>
                                </div>
                                <!--{{ env('APP_URL').'project/storage/app/public/'.$detail[0]['path_prog_de_formation']}}-->
                                <div class="card academy-content shadow-none border">
