                        ...
                        <div class="card-body row g-3">
                            <div class="col-lg-12">
                                ...
                                <div class="card academy-content shadow-none border">
                                    ...
                                    <div class="card-body">
{{--                                        <embed src="{{ env('APP_URL').'project/storage/app/public/'.$detail[0]['path_livret_scientifique']}}" type="application/pdf" width="100%" height="600px">--}}
                                        <embed src="{{ env('APP_URL').'project/storage/app/public/formations/livretscientifique/formation-zengym (2).pdf'}}" type="application/pdf" width="100%" height="600px">
                                    </div>
                                </div>
                                ...
                                <div class="card academy-content shadow-none border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if($detail[0]['approuver'])
                                            <a href="{{route('admin.demande_formation.details.refuser',$detail[0]['id'])}}" class="btn btn-sm btn-icon" style="background-color: red; color: white; width:100%;padding:20px; margin-bottom: 5px">
                                        ...
                                        @else
                                            <a href="{{route('admin.demande_formation.details.approuver',$detail[0]['id'])}}" class="btn btn-sm btn-icon" style="background-color: darkseagreen; color: white; width:100%;padding:20px; margin-bottom: 5px">
