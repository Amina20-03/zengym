<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        @include('layouts.admin.menu',['menuprincipaleactive' =>'formations','menuactive' =>'add_formation'])
                                ...
                                <div class="card-body">
                                    <div class="user-avatar-section">
                                        ...
                                        >
                                            ...
                                            >
                                                <h4 class="mb-2">
                                                    {{ __('content.Ajouter_une_formation') }}
                                                </h4>
                                                <span
                                                    class="badge bg-label-secondary"
                                                >{{ __('content.formations') }}</span
                                                >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-container">
                                        <form method="POST" enctype="multipart/form-data" id="addNewUserForm" action="{{ route('admin.formation.add') }}" class="row g-3">
                                            @csrf
                                            ...
                                            <div class="col-12 col-md-6">
                                                <label for="select2Primary" class="form-label">{{ __('content.formateur') }}</label>
                                                <select id="instructeur_id" name="instructeur_id" class="select2 form-select" required>
                                                    @for($i=0;$i<count($liste);$i++)
                                                        @if($liste[$i]['categ_instructeur_desc'] == 'FORMATEUR')
                                                            <option value="{{$liste[$i]['id']}}">{{$liste[$i]['nom']}} {{$liste[$i]['prenom']}}</option>
                                                        @endif
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <label for="select2Primary" class="form-label">{{ __('content.organisateur') }}</label>
                                                <select id="organisateur_id" name="organisateur_id" class="select2 form-select" required>
                                                    @for($i=0;$i<count($liste);$i++)
                                                        <option value="{{$liste[$i]['id']}}">{{$liste[$i]['nom']}} {{$liste[$i]['prenom']}}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <label for="select2Primary" class="form-label">{{ __('content.photo') }}</label>
                                                <input
                                                    type="file"
                                                    class="form-control"
                                                    id="photo"
                                            ...
                                            <div class="col-12 col-md-6">
                                                <label for="select2Primary" class="form-label">{{ __('content.video') }}</label>
                                                            ...
                                                            @foreach($liste as $elem)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center">
                                                                        <input type="checkbox" name="record"  value="{{$elem['id']}}" onclick="fillTable_instr_id_list()"/>
                                                                    </td>
                                                                    <td style="text-align:center">
                                                                        {{$elem['nom']}}
                                                                    </td>
