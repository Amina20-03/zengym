<div class="layout-wrapper layout-content-navbar">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body pt-3">
                                    <form method="POST"
                                          action="{{ isset($detail)
                                              ? route('admin.programmes.update', $detail['id'])
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="file" name="photo" class="form-control" accept="image/*"
                                                   onchange="previewPhoto(this)">
                                                    ...
                                                    <div class="col-12">
    <label class="form-label fw-semibold">Instructeur <span class="text-danger">*</span></label>
    <select name="instructeur_id" class="form-select" required>
        ...
        @foreach($instructeurs ?? [] as $i)
            <option value="{{ $i['id'] }}"
                {{ (string)($detail['instructeur_id'] ?? '') === (string)$i['id'] ? 'selected' : '' }}>
                {{ $i['nom'] ?? '' }} {{ $i['prenom'] ?? '' }}
            </option>
        @endforeach
    </select>
                                                ...
                                                <div class="row g-2 mb-3">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="card border p-2 d-flex flex-row align-items-center gap-2">
                                                            ...
                                                            <a href="{{ route('admin.programmes.video.delete', $video['id']) }}"
