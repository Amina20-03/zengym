                            ...
                            function (e, t, r) {
                                (function (t) {
                                    ...
                                    var i = function (e, t) {
                                        ...
                                        if (
                                            ("string" == typeof e
                                                ? ((r.element = document.querySelector(
                                                      e
                                                  )),
                                                  (n =
                                        ...
                                        (t.initValue = r.element.value),
                                            (r.properties = i.DefaultProperties.assign(
                                                {},
                                                t
                                            )),
                                            r.init();
                                    ...
                                    (i.prototype = {
                                        init: function () {
                                            ...
                                            0 !== t.blocksLength ||
                                            t.prefix
                                                ? ((t.maxLength = i.Util.getMaxLength(
                                                      t.blocks
                                                  )),
                                                  (e.isAndroid = i.Util.isAndroid()),
                                                  (e.lastInputValue = ""),
                                                  (e.isBackward = ""),
                                                  (e.onChangeListener = e.onChange.bind(
                                                      e
                                                  )),
                                                  (e.onKeyDownListener = e.onKeyDown.bind(
                                                      e
                                                  )),
                                                  (e.onFocusListener = e.onFocus.bind(
                                                      e
                                                  )),
                                                  (e.onCutListener = e.onCut.bind(
                                                      e
                                                  )),
                                                  (e.onCopyListener = e.onCopy.bind(
                                                      e
                                                  )),
                                        ...
                                        initTimeFormatter: function () {
                                            var e = this.properties;
                                            e.time &&
                                                ((e.timeFormatter = new i.TimeFormatter(
                                                    e.timePattern,
                                                    e.timeFormat
                                                )),
                                                ...
                                                (e.blocksLength =
                                                    e.blocks.length),
                                                (e.maxLength = i.Util.getMaxLength(
                                                    e.blocks
                                                )));
                                        },
                                        initDateFormatter: function () {
                                            var e = this.properties;
                                            e.date &&
                                                ((e.dateFormatter = new i.DateFormatter(
                                                    e.datePattern,
                                                    e.dateMin,
                                                    e.dateMax
                                                )),
                                        ...
                                        initPhoneFormatter: function () {
                                            ...
                                            if (e.phone)
                                                try {
                                                    e.phoneFormatter = new i.PhoneFormatter(
                                            ...
                                            return (
                                                ...
                                                r.phone
                                                    ? (!r.prefix ||
                                                      (r.noImmediatePrefix &&
                                                          !e.length)
                                                          ? (r.result = r.phoneFormatter.format(
                                                                e
                                                            ))
                                                          : (r.result =
                                                                r.prefix +
                                                    ...
                                                    ? (r.prefix &&
                                                      ...
                                                      0 === e.length
                                                          ? (r.result = "")
                                                          : (r.result = r.numeralFormatter.format(
                                                                e
                                                            )),
                                                      void t.updateValueState())
                                                    : (r.date &&
                                                          (e = r.dateFormatter.getValidatedDate(
                                                              e
                                                          )),
                                                      r.time &&
                                                          (e = r.timeFormatter.getValidatedTime(
                                                              e
                                                          )),
                                                      (e = n.stripDelimiters(
                                                          e,
                                        ...
                                        updateCreditCardPropsByValue: function (
                                            e
                                        ) {
                                            var t,
                                                r = this.properties,
                                                n = i.Util;
                                            n.headStr(r.result, 4) !==
                                                n.headStr(e, 4) &&
                                                ((t = i.CreditCardDetector.getInfo(
                                                    e,
                                                    r.creditCardStrictMode
                                                )),
                                                (r.blocks = t.blocks),
                                                (r.blocksLength =
                                                    r.blocks.length),
                                                (r.maxLength = n.getMaxLength(
                                                    r.blocks
                                                )),
                                                r.creditCardType !== t.type &&
                                                    ((r.creditCardType =
                                                        t.type),
                                                    r.onCreditCardTypeChanged.call(
                                                        this,
                                                        r.creditCardType
                                                    )));
                                        },
                                        ...
                                        getRawValue: function () {
                                            ...
                                            return (
                                                ...
                                                (r = e.numeral
                                                    ? e.numeralFormatter.getRawValue(
                                                          r
                                                      )
                                                    : t.stripDelimiters(
                                                          r,
                            ...
                            function (e, t) {
                                ...
                                var r = function (
                                    ...
                                    (d.numeralDecimalMark = e || "."),
                                        ...
                                        (d.numeralDecimalScale =
                                            i >= 0 ? i : 2),
                                        (d.numeralThousandsGroupStyle =
                                        ...
                                        assign: function (e, r) {
                                            return (
                                                ...
                                                (e.onCreditCardTypeChanged =
                                                    r.onCreditCardTypeChanged ||
                                                    function () {}),
                                                (e.phone = !!r.phone),
                                                (e.phoneRegionCode =
                                                    r.phoneRegionCode || "AU"),
                                                (e.phoneFormatter = {}),
                                                (e.time = !!r.time),
                                                (e.timePattern = r.timePattern || [
                                                    "h",
                                                    "m",
                                                    "s",
                                                ]),
