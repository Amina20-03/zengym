    ...
    return (function () {
            ...
            static range(e, t) {
                return t
                    ? e && e.loc && t.loc && e.loc.lexer === t.loc.lexer
                        ? new r(e.loc.lexer, e.loc.start, t.loc.end)
                        : null
                    : e && e.loc;
            }
        }
        ...
        class n {
            constructor(e, t) {
                ...
                if (o && o.start <= o.end) {
                    ...
                    (r = o.start),
                        ...
                        r === s.length
                            ? (i += " at end of input: ")
                            : (i += " at position " + (r + 1) + ": ");
                    var l = s.slice(r, a).replace(/[^]/g, "$&Ì²");
                    i +=
                        (r > 15 ? "â€¦" + s.slice(r - 15, r) : s.slice(0, r)) +
                        l +
                        (a + 15 < s.length
                            ? s.slice(a, a + 15) + "â€¦"
                            : s.slice(a));
                ...
                return (
                    (h.name = "ParseError"),
                        (h.__proto__ = n.prototype),
                        (h.position = r),
                    null != r && null != a && (h.length = a - r),
                        (h.rawMessage = e),
                        h
                );
            }
        ...
        class p {
            ...
            isTrusted(e) {
                e.url && !e.protocol && (e.protocol = h.protocolFromUrl(e.url));
                var t =
        ...
        k.forEach((e) => e.blocks.forEach((e) => S.push(...e)));
        var z = 80,
            A = {
                doubleleftarrow:
        ...
        function q(e, t, r) {
            ...
            if (
                (!n &&
                e[0] in N &&
                ((a = N[e[0]].charCodeAt(0)), (n = B[t][a])),
                n || "text" !== r || (M(a) && (n = B[t][77])),
                    n)
            )
                return {
                    depth: n[0],
        ...
        var R = [
            ...
            H = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
            O = function (e, t) {
                return t.size < 2 ? e : R[e - 1][t.size - 1];
            };
        class E {
            constructor(e) {
                (this.style = void 0),
            ...
            havingStyle(e) {
                return this.style === e
                    ? this
                    : this.extend({ style: e, size: O(this.textSize, e) });
            }
            havingCrampedStyle() {
            ...
            fontMetrics() {
                return (
                    ...
                    (this._fontMetrics = (function (e) {
                        var t;
                        if (!I[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                            var r = (I[t] = { cssEmPerMu: C.quad[t] / 18 });
                            for (var a in C)
                                C.hasOwnProperty(a) && (r[a] = C[a][t]);
                        }
                        return I[t];
                    })(this.size)),
                        this._fontMetrics
        ...
        var L = {
            ...
            X = function (e) {
                var t = "<" + e;
                this.classes.length &&
                (t += ' class="' + h.escape(G(this.classes)) + '"');
                var r = "";
                for (var a in this.style)
                    this.style.hasOwnProperty(a) &&
                    (r += h.hyphenate(a) + ":" + this.style[a] + ";");
                for (var n in (r && (t += ' style="' + h.escape(r) + '"'),
                    this.attributes))
        ...
        class j {
            ...
            toMarkup() {
                ...
                for (var r in this.style)
                    this.style.hasOwnProperty(r) &&
                    (t += h.hyphenate(r) + ":" + this.style[r] + ";");
                return t && (e += ' style="' + h.escape(t) + '"'), (e += "'/>");
            }
        }
        var $ = { "Ã®": "Ä±Ì‚", "Ã¯": "Ä±Ìˆ", "Ã­": "Ä±Ì", "Ã¬": "Ä±Ì€" };
        class Z {
            constructor(e, t, r, a, n, i, o, s) {
                ...
                var l = (function (e) {
                    for (var t = 0; t < k.length; t++)
                        for (var r = k[t], a = 0; a < r.blocks.length; a++) {
                            var n = r.blocks[a];
                ...
                /[Ã®Ã¯Ã­Ã¬]/.test(this.text) && (this.text = $[this.text]);
            }
            hasClass(e) {
                return h.contains(this.classes, e);
            }
            toNode() {
                ...
                ((t = document.createElement("span")).style.marginRight = F(
                    this.italic
                )),
                this.classes.length > 0 &&
                ((t = t || document.createElement("span")).className = G(
                    this.classes
                )),
                    this.style))
                    this.style.hasOwnProperty(r) &&
            ...
            toNode() {
                ...
                return (
                    this.alternate
                        ...
                        : e.setAttribute("d", A[this.pathName]),
                        e
                );
            }
            toMarkup() {
        ...
        function ne(e, t, r, a, n, i) {
            (ae[e][n] = { font: t, group: r, replace: a }),
            i && a && (ae[e][a] = ae[e][n]);
        }
        var ie = "math",
            oe = "text",
            ...
            be = "spacing",
            ye = "textord";
        ne(ie, se, ve, "â‰¡", "\\equiv", !0),
            ne(ie, se, ve, "â‰º", "\\prec", !0),
            ne(ie, se, ve, "â‰»", "\\succ", !0),
            ne(ie, se, ve, "âˆ¼", "\\sim", !0),
            ne(ie, se, ve, "âŠ¥", "\\perp"),
            ne(ie, se, ve, "âª¯", "\\preceq", !0),
            ne(ie, se, ve, "âª°", "\\succeq", !0),
            ne(ie, se, ve, "â‰ƒ", "\\simeq", !0),
            ne(ie, se, ve, "âˆ£", "\\mid", !0),
            ne(ie, se, ve, "â‰ª", "\\ll", !0),
            ne(ie, se, ve, "â‰«", "\\gg", !0),
            ne(ie, se, ve, "â‰", "\\asymp", !0),
            ne(ie, se, ve, "âˆ¥", "\\parallel"),
            ne(ie, se, ve, "â‹ˆ", "\\bowtie", !0),
            ne(ie, se, ve, "âŒ£", "\\smile", !0),
            ne(ie, se, ve, "âŠ‘", "\\sqsubseteq", !0),
            ne(ie, se, ve, "âŠ’", "\\sqsupseteq", !0),
            ne(ie, se, ve, "â‰", "\\doteq", !0),
            ne(ie, se, ve, "âŒ¢", "\\frown", !0),
            ne(ie, se, ve, "âˆ‹", "\\ni", !0),
            ne(ie, se, ve, "âˆ", "\\propto", !0),
            ne(ie, se, ve, "âŠ¢", "\\vdash", !0),
            ne(ie, se, ve, "âŠ£", "\\dashv", !0),
            ne(ie, se, ve, "âˆ‹", "\\owns"),
            ne(ie, se, fe, ".", "\\ldotp"),
            ne(ie, se, fe, "â‹…", "\\cdotp"),
            ne(ie, se, ye, "#", "\\#"),
            ...
            ne(ie, se, ye, "&", "\\&"),
            ne(oe, se, ye, "&", "\\&"),
            ne(ie, se, ye, "â„µ", "\\aleph", !0),
            ne(ie, se, ye, "âˆ€", "\\forall", !0),
            ne(ie, se, ye, "â„", "\\hbar", !0),
            ne(ie, se, ye, "âˆƒ", "\\exists", !0),
            ne(ie, se, ye, "âˆ‡", "\\nabla", !0),
            ne(ie, se, ye, "â™­", "\\flat", !0),
            ne(ie, se, ye, "â„“", "\\ell", !0),
            ne(ie, se, ye, "â™®", "\\natural", !0),
            ne(ie, se, ye, "â™£", "\\clubsuit", !0),
            ne(ie, se, ye, "â„˜", "\\wp", !0),
            ne(ie, se, ye, "â™¯", "\\sharp", !0),
            ne(ie, se, ye, "â™¢", "\\diamondsuit", !0),
            ne(ie, se, ye, "â„œ", "\\Re", !0),
            ne(ie, se, ye, "â™¡", "\\heartsuit", !0),
            ne(ie, se, ye, "â„‘", "\\Im", !0),
            ne(ie, se, ye, "â™ ", "\\spadesuit", !0),
            ne(ie, se, ye, "Â§", "\\S", !0),
            ne(oe, se, ye, "Â§", "\\S"),
            ne(ie, se, ye, "Â¶", "\\P", !0),
            ne(oe, se, ye, "Â¶", "\\P"),
            ne(ie, se, ye, "â€ ", "\\dag"),
            ne(oe, se, ye, "â€ ", "\\dag"),
            ne(oe, se, ye, "â€ ", "\\textdagger"),
            ne(ie, se, ye, "â€¡", "\\ddag"),
            ne(oe, se, ye, "â€¡", "\\ddag"),
            ne(oe, se, ye, "â€¡", "\\textdaggerdbl"),
            ne(ie, se, ce, "âŽ±", "\\rmoustache", !0),
            ne(ie, se, ge, "âŽ°", "\\lmoustache", !0),
            ne(ie, se, ce, "âŸ¯", "\\rgroup", !0),
            ne(ie, se, ge, "âŸ®", "\\lgroup", !0),
            ne(ie, se, me, "âˆ“", "\\mp", !0),
            ne(ie, se, me, "âŠ–", "\\ominus", !0),
            ne(ie, se, me, "âŠŽ", "\\uplus", !0),
            ne(ie, se, me, "âŠ“", "\\sqcap", !0),
            ne(ie, se, me, "âˆ—", "\\ast"),
            ne(ie, se, me, "âŠ”", "\\sqcup", !0),
            ne(ie, se, me, "â—¯", "\\bigcirc", !0),
            ne(ie, se, me, "âˆ™", "\\bullet", !0),
            ne(ie, se, me, "â€¡", "\\ddagger"),
            ne(ie, se, me, "â‰€", "\\wr", !0),
            ne(ie, se, me, "â¨¿", "\\amalg"),
            ne(ie, se, me, "&", "\\And"),
            ne(ie, se, ve, "âŸµ", "\\longleftarrow", !0),
            ne(ie, se, ve, "â‡", "\\Leftarrow", !0),
            ne(ie, se, ve, "âŸ¸", "\\Longleftarrow", !0),
            ne(ie, se, ve, "âŸ¶", "\\longrightarrow", !0),
            ne(ie, se, ve, "â‡’", "\\Rightarrow", !0),
            ne(ie, se, ve, "âŸ¹", "\\Longrightarrow", !0),
            ne(ie, se, ve, "â†”", "\\leftrightarrow", !0),
            ne(ie, se, ve, "âŸ·", "\\longleftrightarrow", !0),
            ne(ie, se, ve, "â‡”", "\\Leftrightarrow", !0),
            ne(ie, se, ve, "âŸº", "\\Longleftrightarrow", !0),
            ne(ie, se, ve, "â†¦", "\\mapsto", !0),
            ne(ie, se, ve, "âŸ¼", "\\longmapsto", !0),
            ne(ie, se, ve, "â†—", "\\nearrow", !0),
            ne(ie, se, ve, "â†©", "\\hookleftarrow", !0),
            ne(ie, se, ve, "â†ª", "\\hookrightarrow", !0),
            ne(ie, se, ve, "â†˜", "\\searrow", !0),
            ne(ie, se, ve, "â†¼", "\\leftharpoonup", !0),
            ne(ie, se, ve, "â‡€", "\\rightharpoonup", !0),
            ne(ie, se, ve, "â†™", "\\swarrow", !0),
            ne(ie, se, ve, "â†½", "\\leftharpoondown", !0),
            ne(ie, se, ve, "â‡", "\\rightharpoondown", !0),
            ne(ie, se, ve, "â†–", "\\nwarrow", !0),
            ne(ie, se, ve, "â‡Œ", "\\rightleftharpoons", !0),
            ne(ie, le, ve, "â‰®", "\\nless", !0),
            ne(ie, le, ve, "î€", "\\@nleqslant"),
            ne(ie, le, ve, "î€‘", "\\@nleqq"),
            ne(ie, le, ve, "âª‡", "\\lneq", !0),
            ne(ie, le, ve, "â‰¨", "\\lneqq", !0),
            ne(ie, le, ve, "î€Œ", "\\@lvertneqq"),
        ne(ie, le, ve, "â‹¦", "\\lnsim", !0),
        ne(ie, le, ve, "âª‰", "\\lnapprox", !0),
        ne(ie, le, ve, "âŠ€", "\\nprec", !0),
        ne(ie, le, ve, "â‹ ", "\\npreceq", !0),
        ne(ie, le, ve, "â‹¨", "\\precnsim", !0),
        ne(ie, le, ve, "âª¹", "\\precnapprox", !0),
        ne(ie, le, ve, "â‰", "\\nsim", !0),
        ne(ie, le, ve, "î€†", "\\@nshortmid"),
        ne(ie, le, ve, "âˆ¤", "\\nmid", !0),
        ne(ie, le, ve, "âŠ¬", "\\nvdash", !0),
        ne(ie, le, ve, "âŠ­", "\\nvDash", !0),
        ne(ie, le, ve, "â‹ª", "\\ntriangleleft"),
        ne(ie, le, ve, "â‹¬", "\\ntrianglelefteq", !0),
        ne(ie, le, ve, "âŠŠ", "\\subsetneq", !0),
        ne(ie, le, ve, "î€š", "\\@varsubsetneq"),
        ne(ie, le, ve, "â«‹", "\\subsetneqq", !0),
        ne(ie, le, ve, "î€—", "\\@varsubsetneqq"),
        ne(ie, le, ve, "â‰¯", "\\ngtr", !0),
        ne(ie, le, ve, "î€", "\\@ngeqslant"),
        ne(ie, le, ve, "î€Ž", "\\@ngeqq"),
        ne(ie, le, ve, "âªˆ", "\\gneq", !0),
        ne(ie, le, ve, "â‰©", "\\gneqq", !0),
        ne(ie, le, ve, "î€", "\\@gvertneqq"),
        ne(ie, le, ve, "â‹§", "\\gnsim", !0),
        ne(ie, le, ve, "âªŠ", "\\gnapprox", !0),
        ne(ie, le, ve, "âŠ", "\\nsucc", !0),
        ne(ie, le, ve, "â‹¡", "\\nsucceq", !0),
        ne(ie, le, ve, "â‹©", "\\succnsim", !0),
        ne(ie, le, ve, "âªº", "\\succnapprox", !0),
        ne(ie, le, ve, "â‰†", "\\ncong", !0),
        ne(ie, le, ve, "î€‡", "\\@nshortparallel"),
        ne(ie, le, ve, "âˆ¦", "\\nparallel", !0),
        ne(ie, le, ve, "âŠ¯", "\\nVDash", !0),
        ne(ie, le, ve, "â‹«", "\\ntriangleright"),
        ne(ie, le, ve, "â‹­", "\\ntrianglerighteq", !0),
        ne(ie, le, ve, "î€˜", "\\@nsupseteqq"),
        ne(ie, le, ve, "âŠ‹", "\\supsetneq", !0),
        ne(ie, le, ve, "î€›", "\\@varsupsetneq"),
        ne(ie, le, ve, "â«Œ", "\\supsetneqq", !0),
        ne(ie, le, ve, "î€™", "\\@varsupsetneqq"),
        ne(ie, le, ve, "âŠ®", "\\nVdash", !0),
        ne(ie, le, ve, "âªµ", "\\precneqq", !0),
        ne(ie, le, ve, "âª¶", "\\succneqq", !0),
        ne(ie, le, ve, "î€–", "\\@nsubseteqq"),
        ne(ie, le, me, "âŠ´", "\\unlhd"),
        ne(ie, le, me, "âŠµ", "\\unrhd"),
        ne(ie, le, ve, "â†š", "\\nleftarrow", !0),
        ne(ie, le, ve, "â†›", "\\nrightarrow", !0),
        ne(ie, le, ve, "â‡", "\\nLeftarrow", !0),
        ne(ie, le, ve, "â‡", "\\nRightarrow", !0),
        ne(ie, le, ve, "â†®", "\\nleftrightarrow", !0),
        ne(ie, le, ve, "â‡Ž", "\\nLeftrightarrow", !0),
        ne(ie, le, ve, "â–³", "\\vartriangle"),
        ne(ie, le, ye, "â„", "\\hslash"),
        ne(ie, le, ye, "â–½", "\\triangledown"),
        ne(ie, le, ye, "â—Š", "\\lozenge"),
        ne(ie, le, ye, "â“ˆ", "\\circledS"),
        ne(ie, le, ye, "Â®", "\\circledR"),
        ne(oe, le, ye, "Â®", "\\circledR"),
        ne(ie, le, ye, "âˆ¡", "\\measuredangle", !0),
        ne(ie, le, ye, "âˆ„", "\\nexists"),
        ne(ie, le, ye, "â„§", "\\mho"),
        ne(ie, le, ye, "â„²", "\\Finv", !0),
        ne(ie, le, ye, "â…", "\\Game", !0),
        ne(ie, le, ye, "â€µ", "\\backprime"),
        ne(ie, le, ye, "â–²", "\\blacktriangle"),
        ne(ie, le, ye, "â–¼", "\\blacktriangledown"),
        ne(ie, le, ye, "â– ", "\\blacksquare"),
        ne(ie, le, ye, "â§«", "\\blacklozenge"),
        ne(ie, le, ye, "â˜…", "\\bigstar"),
        ne(ie, le, ye, "âˆ¢", "\\sphericalangle", !0),
        ne(ie, le, ye, "âˆ", "\\complement", !0),
        ne(ie, le, ye, "Ã°", "\\eth", !0),
        ne(oe, se, ye, "Ã°", "Ã°"),
        ne(ie, le, ye, "â•±", "\\diagup"),
        ne(ie, le, ye, "â•²", "\\diagdown"),
        ne(ie, le, ye, "â–¡", "\\square"),
        ne(ie, le, ye, "â–¡", "\\Box"),
        ne(ie, le, ye, "â—Š", "\\Diamond"),
        ne(ie, le, ye, "Â¥", "\\yen", !0),
        ne(oe, le, ye, "Â¥", "\\yen", !0),
        ne(ie, le, ye, "âœ“", "\\checkmark", !0),
        ne(oe, le, ye, "âœ“", "\\checkmark"),
        ne(ie, le, ye, "â„¶", "\\beth", !0),
        ne(ie, le, ye, "â„¸", "\\daleth", !0),
        ne(ie, le, ye, "â„·", "\\gimel", !0),
        ne(ie, le, ye, "Ï", "\\digamma", !0),
        ne(ie, le, ye, "Ï°", "\\varkappa"),
        ne(ie, le, ge, "â”Œ", "\\@ulcorner", !0),
        ne(ie, le, ce, "â”", "\\@urcorner", !0),
        ne(ie, le, ge, "â””", "\\@llcorner", !0),
        ne(ie, le, ce, "â”˜", "\\@lrcorner", !0),
        ne(ie, le, ve, "â‰¦", "\\leqq", !0),
        ne(ie, le, ve, "â©½", "\\leqslant", !0),
        ne(ie, le, ve, "âª•", "\\eqslantless", !0),
        ne(ie, le, ve, "â‰²", "\\lesssim", !0),
        ne(ie, le, ve, "âª…", "\\lessapprox", !0),
        ne(ie, le, ve, "â‰Š", "\\approxeq", !0),
        ne(ie, le, me, "â‹–", "\\lessdot"),
        ne(ie, le, ve, "â‹˜", "\\lll", !0),
        ne(ie, le, ve, "â‰¶", "\\lessgtr", !0),
        ne(ie, le, ve, "â‹š", "\\lesseqgtr", !0),
        ne(ie, le, ve, "âª‹", "\\lesseqqgtr", !0),
        ne(ie, le, ve, "â‰‘", "\\doteqdot"),
        ne(ie, le, ve, "â‰“", "\\risingdotseq", !0),
        ne(ie, le, ve, "â‰’", "\\fallingdotseq", !0),
        ne(ie, le, ve, "âˆ½", "\\backsim", !0),
        ne(ie, le, ve, "â‹", "\\backsimeq", !0),
        ne(ie, le, ve, "â«…", "\\subseteqq", !0),
        ne(ie, le, ve, "â‹", "\\Subset", !0),
        ne(ie, le, ve, "âŠ", "\\sqsubset", !0),
        ne(ie, le, ve, "â‰¼", "\\preccurlyeq", !0),
        ne(ie, le, ve, "â‹ž", "\\curlyeqprec", !0),
        ne(ie, le, ve, "â‰¾", "\\precsim", !0),
        ne(ie, le, ve, "âª·", "\\precapprox", !0),
        ne(ie, le, ve, "âŠ²", "\\vartriangleleft"),
        ne(ie, le, ve, "âŠ´", "\\trianglelefteq"),
        ne(ie, le, ve, "âŠ¨", "\\vDash", !0),
        ne(ie, le, ve, "âŠª", "\\Vvdash", !0),
        ne(ie, le, ve, "âŒ£", "\\smallsmile"),
        ne(ie, le, ve, "âŒ¢", "\\smallfrown"),
        ne(ie, le, ve, "â‰", "\\bumpeq", !0),
        ne(ie, le, ve, "â‰Ž", "\\Bumpeq", !0),
        ne(ie, le, ve, "â‰§", "\\geqq", !0),
        ne(ie, le, ve, "â©¾", "\\geqslant", !0),
        ne(ie, le, ve, "âª–", "\\eqslantgtr", !0),
        ne(ie, le, ve, "â‰³", "\\gtrsim", !0),
        ne(ie, le, ve, "âª†", "\\gtrapprox", !0),
        ne(ie, le, me, "â‹—", "\\gtrdot"),
        ne(ie, le, ve, "â‹™", "\\ggg", !0),
        ne(ie, le, ve, "â‰·", "\\gtrless", !0),
        ne(ie, le, ve, "â‹›", "\\gtreqless", !0),
        ne(ie, le, ve, "âªŒ", "\\gtreqqless", !0),
        ne(ie, le, ve, "â‰–", "\\eqcirc", !0),
        ne(ie, le, ve, "â‰—", "\\circeq", !0),
        ne(ie, le, ve, "â‰œ", "\\triangleq", !0),
        ne(ie, le, ve, "âˆ¼", "\\thicksim"),
        ne(ie, le, ve, "â‰ˆ", "\\thickapprox"),
        ne(ie, le, ve, "â«†", "\\supseteqq", !0),
        ne(ie, le, ve, "â‹‘", "\\Supset", !0),
        ne(ie, le, ve, "âŠ", "\\sqsupset", !0),
        ne(ie, le, ve, "â‰½", "\\succcurlyeq", !0),
        ne(ie, le, ve, "â‹Ÿ", "\\curlyeqsucc", !0),
        ne(ie, le, ve, "â‰¿", "\\succsim", !0),
        ne(ie, le, ve, "âª¸", "\\succapprox", !0),
        ne(ie, le, ve, "âŠ³", "\\vartriangleright"),
        ne(ie, le, ve, "âŠµ", "\\trianglerighteq"),
        ne(ie, le, ve, "âŠ©", "\\Vdash", !0),
        ne(ie, le, ve, "âˆ£", "\\shortmid"),
        ne(ie, le, ve, "âˆ¥", "\\shortparallel"),
        ne(ie, le, ve, "â‰¬", "\\between", !0),
        ne(ie, le, ve, "â‹”", "\\pitchfork", !0),
        ne(ie, le, ve, "âˆ", "\\varpropto"),
        ne(ie, le, ve, "â—€", "\\blacktriangleleft"),
        ne(ie, le, ve, "âˆ´", "\\therefore", !0),
        ne(ie, le, ve, "âˆ", "\\backepsilon"),
        ne(ie, le, ve, "â–¶", "\\blacktriangleright"),
        ne(ie, le, ve, "âˆµ", "\\because", !0),
        ne(ie, le, ve, "â‹˜", "\\llless"),
        ne(ie, le, ve, "â‹™", "\\gggtr"),
        ne(ie, le, me, "âŠ²", "\\lhd"),
        ne(ie, le, me, "âŠ³", "\\rhd"),
        ne(ie, le, ve, "â‰‚", "\\eqsim", !0),
        ne(ie, se, ve, "â‹ˆ", "\\Join"),
        ne(ie, le, ve, "â‰‘", "\\Doteq", !0),
        ne(ie, le, me, "âˆ”", "\\dotplus", !0),
        ne(ie, le, me, "âˆ–", "\\smallsetminus"),
        ne(ie, le, me, "â‹’", "\\Cap", !0),
        ne(ie, le, me, "â‹“", "\\Cup", !0),
        ne(ie, le, me, "â©ž", "\\doublebarwedge", !0),
        ne(ie, le, me, "âŠŸ", "\\boxminus", !0),
        ne(ie, le, me, "âŠž", "\\boxplus", !0),
        ne(ie, le, me, "â‹‡", "\\divideontimes", !0),
        ne(ie, le, me, "â‹‰", "\\ltimes", !0),
        ne(ie, le, me, "â‹Š", "\\rtimes", !0),
        ne(ie, le, me, "â‹‹", "\\leftthreetimes", !0),
        ne(ie, le, me, "â‹Œ", "\\rightthreetimes", !0),
        ne(ie, le, me, "â‹", "\\curlywedge", !0),
        ne(ie, le, me, "â‹Ž", "\\curlyvee", !0),
        ne(ie, le, me, "âŠ", "\\circleddash", !0),
        ne(ie, le, me, "âŠ›", "\\circledast", !0),
        ne(ie, le, me, "â‹…", "\\centerdot"),
        ne(ie, le, me, "âŠº", "\\intercal", !0),
        ne(ie, le, me, "â‹’", "\\doublecap"),
        ne(ie, le, me, "â‹“", "\\doublecup"),
        ne(ie, le, me, "âŠ ", "\\boxtimes", !0),
        ne(ie, le, ve, "â‡¢", "\\dashrightarrow", !0),
        ne(ie, le, ve, "â‡ ", "\\dashleftarrow", !0),
        ne(ie, le, ve, "â‡‡", "\\leftleftarrows", !0),
        ne(ie, le, ve, "â‡†", "\\leftrightarrows", !0),
        ne(ie, le, ve, "â‡š", "\\Lleftarrow", !0),
        ne(ie, le, ve, "â†ž", "\\twoheadleftarrow", !0),
        ne(ie, le, ve, "â†¢", "\\leftarrowtail", !0),
        ne(ie, le, ve, "â†«", "\\looparrowleft", !0),
        ne(ie, le, ve, "â‡‹", "\\leftrightharpoons", !0),
        ne(ie, le, ve, "â†¶", "\\curvearrowleft", !0),
        ne(ie, le, ve, "â†º", "\\circlearrowleft", !0),
        ne(ie, le, ve, "â†°", "\\Lsh", !0),
        ne(ie, le, ve, "â‡ˆ", "\\upuparrows", !0),
        ne(ie, le, ve, "â†¿", "\\upharpoonleft", !0),
        ne(ie, le, ve, "â‡ƒ", "\\downharpoonleft", !0),
        ne(ie, se, ve, "âŠ¶", "\\origof", !0),
        ne(ie, se, ve, "âŠ·", "\\imageof", !0),
        ne(ie, le, ve, "âŠ¸", "\\multimap", !0),
        ne(ie, le, ve, "â†­", "\\leftrightsquigarrow", !0),
        ne(ie, le, ve, "â‡‰", "\\rightrightarrows", !0),
        ne(ie, le, ve, "â‡„", "\\rightleftarrows", !0),
        ne(ie, le, ve, "â† ", "\\twoheadrightarrow", !0),
        ne(ie, le, ve, "â†£", "\\rightarrowtail", !0),
        ne(ie, le, ve, "â†¬", "\\looparrowright", !0),
        ne(ie, le, ve, "â†·", "\\curvearrowright", !0),
        ne(ie, le, ve, "â†»", "\\circlearrowright", !0),
        ne(ie, le, ve, "â†±", "\\Rsh", !0),
        ne(ie, le, ve, "â‡Š", "\\downdownarrows", !0),
        ne(ie, le, ve, "â†¾", "\\upharpoonright", !0),
        ne(ie, le, ve, "â‡‚", "\\downharpoonright", !0),
        ne(ie, le, ve, "â‡", "\\rightsquigarrow", !0),
        ne(ie, le, ve, "â‡", "\\leadsto"),
        ne(ie, le, ve, "â‡›", "\\Rrightarrow", !0),
        ne(ie, le, ve, "â†¾", "\\restriction"),
        ne(ie, se, ye, "â€˜", "`"),
        ne(ie, se, ye, "$", "\\$"),
        ne(oe, se, ye, "$", "\\$"),
        ne(oe, se, ye, "$", "\\textdollar"),
        ne(ie, se, ye, "%", "\\%"),
        ne(oe, se, ye, "%", "\\%"),
        ne(ie, se, ye, "_", "\\_"),
        ne(oe, se, ye, "_", "\\_"),
        ne(oe, se, ye, "_", "\\textunderscore"),
        ne(ie, se, ye, "âˆ ", "\\angle", !0),
        ne(ie, se, ye, "âˆž", "\\infty", !0),
        ne(ie, se, ye, "â€²", "\\prime"),
        ne(ie, se, ye, "â–³", "\\triangle"),
        ne(ie, se, ye, "Î“", "\\Gamma", !0),
        ne(ie, se, ye, "Î”", "\\Delta", !0),
        ne(ie, se, ye, "Î˜", "\\Theta", !0),
        ne(ie, se, ye, "Î›", "\\Lambda", !0),
        ne(ie, se, ye, "Îž", "\\Xi", !0),
        ne(ie, se, ye, "Î ", "\\Pi", !0),
        ne(ie, se, ye, "Î£", "\\Sigma", !0),
        ne(ie, se, ye, "Î¥", "\\Upsilon", !0),
        ne(ie, se, ye, "Î¦", "\\Phi", !0),
        ne(ie, se, ye, "Î¨", "\\Psi", !0),
        ne(ie, se, ye, "Î©", "\\Omega", !0),
        ne(ie, se, ye, "A", "Î‘"),
        ne(ie, se, ye, "B", "Î’"),
        ne(ie, se, ye, "E", "Î•"),
        ne(ie, se, ye, "Z", "Î–"),
        ...
        ne(ie, se, ye, "âŠ¤", "\\top"),
        ne(ie, se, ye, "âŠ¥", "\\bot"),
        ne(ie, se, ye, "âˆ…", "\\emptyset"),
        ne(ie, le, ye, "âˆ…", "\\varnothing"),
        ne(ie, se, ue, "Î±", "\\alpha", !0),
        ne(ie, se, ue, "Î²", "\\beta", !0),
        ne(ie, se, ue, "Î³", "\\gamma", !0),
        ne(ie, se, ue, "Î´", "\\delta", !0),
        ne(ie, se, ue, "Ïµ", "\\epsilon", !0),
        ne(ie, se, ue, "Î¶", "\\zeta", !0),
        ne(ie, se, ue, "Î·", "\\eta", !0),
        ne(ie, se, ue, "Î¸", "\\theta", !0),
        ne(ie, se, ue, "Î¹", "\\iota", !0),
        ne(ie, se, ue, "Îº", "\\kappa", !0),
        ne(ie, se, ue, "Î»", "\\lambda", !0),
        ne(ie, se, ue, "Î¼", "\\mu", !0),
        ne(ie, se, ue, "Î½", "\\nu", !0),
        ne(ie, se, ue, "Î¾", "\\xi", !0),
        ne(ie, se, ue, "Î¿", "\\omicron", !0),
        ne(ie, se, ue, "Ï€", "\\pi", !0),
        ne(ie, se, ue, "Ï", "\\rho", !0),
        ne(ie, se, ue, "Ïƒ", "\\sigma", !0),
        ne(ie, se, ue, "Ï„", "\\tau", !0),
        ne(ie, se, ue, "Ï…", "\\upsilon", !0),
        ne(ie, se, ue, "Ï•", "\\phi", !0),
        ne(ie, se, ue, "Ï‡", "\\chi", !0),
        ne(ie, se, ue, "Ïˆ", "\\psi", !0),
        ne(ie, se, ue, "Ï‰", "\\omega", !0),
        ne(ie, se, ue, "Îµ", "\\varepsilon", !0),
        ne(ie, se, ue, "Ï‘", "\\vartheta", !0),
        ne(ie, se, ue, "Ï–", "\\varpi", !0),
        ne(ie, se, ue, "Ï±", "\\varrho", !0),
        ne(ie, se, ue, "Ï‚", "\\varsigma", !0),
        ne(ie, se, ue, "Ï†", "\\varphi", !0),
        ne(ie, se, me, "âˆ—", "*", !0),
        ne(ie, se, me, "+", "+"),
        ne(ie, se, me, "âˆ’", "-", !0),
        ne(ie, se, me, "â‹…", "\\cdot", !0),
        ne(ie, se, me, "âˆ˜", "\\circ", !0),
        ne(ie, se, me, "Ã·", "\\div", !0),
        ne(ie, se, me, "Â±", "\\pm", !0),
        ne(ie, se, me, "Ã—", "\\times", !0),
        ne(ie, se, me, "âˆ©", "\\cap", !0),
        ne(ie, se, me, "âˆª", "\\cup", !0),
        ne(ie, se, me, "âˆ–", "\\setminus", !0),
        ne(ie, se, me, "âˆ§", "\\land"),
        ne(ie, se, me, "âˆ¨", "\\lor"),
        ne(ie, se, me, "âˆ§", "\\wedge", !0),
        ne(ie, se, me, "âˆ¨", "\\vee", !0),
        ne(ie, se, ye, "âˆš", "\\surd"),
        ne(ie, se, ge, "âŸ¨", "\\langle", !0),
        ne(ie, se, ge, "âˆ£", "\\lvert"),
        ne(ie, se, ge, "âˆ¥", "\\lVert"),
        ne(ie, se, ce, "?", "?"),
        ne(ie, se, ce, "!", "!"),
        ne(ie, se, ce, "âŸ©", "\\rangle", !0),
        ne(ie, se, ce, "âˆ£", "\\rvert"),
        ne(ie, se, ce, "âˆ¥", "\\rVert"),
        ne(ie, se, ve, "=", "="),
        ne(ie, se, ve, ":", ":"),
        ne(ie, se, ve, "â‰ˆ", "\\approx", !0),
        ne(ie, se, ve, "â‰…", "\\cong", !0),
        ne(ie, se, ve, "â‰¥", "\\ge"),
        ne(ie, se, ve, "â‰¥", "\\geq", !0),
        ne(ie, se, ve, "â†", "\\gets"),
        ne(ie, se, ve, ">", "\\gt", !0),
        ne(ie, se, ve, "âˆˆ", "\\in", !0),
        ne(ie, se, ve, "î€ ", "\\@not"),
        ne(ie, se, ve, "âŠ‚", "\\subset", !0),
        ne(ie, se, ve, "âŠƒ", "\\supset", !0),
        ne(ie, se, ve, "âŠ†", "\\subseteq", !0),
        ne(ie, se, ve, "âŠ‡", "\\supseteq", !0),
        ne(ie, le, ve, "âŠˆ", "\\nsubseteq", !0),
        ne(ie, le, ve, "âŠ‰", "\\nsupseteq", !0),
        ne(ie, se, ve, "âŠ¨", "\\models"),
        ne(ie, se, ve, "â†", "\\leftarrow", !0),
        ne(ie, se, ve, "â‰¤", "\\le"),
        ne(ie, se, ve, "â‰¤", "\\leq", !0),
        ne(ie, se, ve, "<", "\\lt", !0),
        ...
        ne(oe, se, be, "Â ", "\\nobreakspace"),
        ne(ie, se, be, null, "\\nobreak"),
        ne(ie, se, be, null, "\\allowbreak"),
        ne(ie, se, fe, ",", ","),
        ne(ie, se, fe, ";", ";"),
        ne(ie, le, me, "âŠ¼", "\\barwedge", !0),
        ne(ie, le, me, "âŠ»", "\\veebar", !0),
        ne(ie, se, me, "âŠ™", "\\odot", !0),
        ne(ie, se, me, "âŠ•", "\\oplus", !0),
        ne(ie, se, me, "âŠ—", "\\otimes", !0),
        ne(ie, se, ye, "âˆ‚", "\\partial", !0),
        ne(ie, se, me, "âŠ˜", "\\oslash", !0),
        ne(ie, le, me, "âŠš", "\\circledcirc", !0),
        ne(ie, le, me, "âŠ¡", "\\boxdot", !0),
        ne(ie, se, me, "â–³", "\\bigtriangleup"),
        ne(ie, se, me, "â–½", "\\bigtriangledown"),
        ne(ie, se, me, "â€ ", "\\dagger"),
        ne(ie, se, me, "â‹„", "\\diamond"),
        ne(ie, se, me, "â‹†", "\\star"),
        ne(ie, se, me, "â—ƒ", "\\triangleleft"),
        ne(ie, se, me, "â–¹", "\\triangleright"),
        ne(ie, se, ge, "{", "\\{"),
        ne(oe, se, ye, "{", "\\{"),
        ne(oe, se, ye, "{", "\\textbraceleft"),
        ne(ie, se, ce, "}", "\\}"),
        ne(oe, se, ye, "}", "\\}"),
        ne(oe, se, ye, "}", "\\textbraceright"),
        ne(ie, se, ge, "{", "\\lbrace"),
        ne(ie, se, ce, "}", "\\rbrace"),
        ne(ie, se, ge, "[", "\\lbrack", !0),
        ne(oe, se, ye, "[", "\\lbrack", !0),
        ne(ie, se, ce, "]", "\\rbrack", !0),
        ne(oe, se, ye, "]", "\\rbrack", !0),
        ne(ie, se, ge, "(", "\\lparen", !0),
        ne(ie, se, ce, ")", "\\rparen", !0),
        ne(oe, se, ye, "<", "\\textless", !0),
        ne(oe, se, ye, ">", "\\textgreater", !0),
        ne(ie, se, ge, "âŒŠ", "\\lfloor", !0),
        ne(ie, se, ce, "âŒ‹", "\\rfloor", !0),
        ne(ie, se, ge, "âŒˆ", "\\lceil", !0),
        ne(ie, se, ce, "âŒ‰", "\\rceil", !0),
        ne(ie, se, ye, "\\", "\\backslash"),
        ne(ie, se, ye, "âˆ£", "|"),
        ne(ie, se, ye, "âˆ£", "\\vert"),
        ne(oe, se, ye, "|", "\\textbar", !0),
        ne(ie, se, ye, "âˆ¥", "\\|"),
        ne(ie, se, ye, "âˆ¥", "\\Vert"),
        ne(oe, se, ye, "âˆ¥", "\\textbardbl"),
        ne(oe, se, ye, "~", "\\textasciitilde"),
        ne(oe, se, ye, "\\", "\\textbackslash"),
        ne(oe, se, ye, "^", "\\textasciicircum"),
        ne(ie, se, ve, "â†‘", "\\uparrow", !0),
        ne(ie, se, ve, "â‡‘", "\\Uparrow", !0),
        ne(ie, se, ve, "â†“", "\\downarrow", !0),
        ne(ie, se, ve, "â‡“", "\\Downarrow", !0),
        ne(ie, se, ve, "â†•", "\\updownarrow", !0),
        ne(ie, se, ve, "â‡•", "\\Updownarrow", !0),
        ne(ie, se, de, "âˆ", "\\coprod"),
        ne(ie, se, de, "â‹", "\\bigvee"),
        ne(ie, se, de, "â‹€", "\\bigwedge"),
        ne(ie, se, de, "â¨„", "\\biguplus"),
        ne(ie, se, de, "â‹‚", "\\bigcap"),
        ne(ie, se, de, "â‹ƒ", "\\bigcup"),
        ne(ie, se, de, "âˆ«", "\\int"),
        ne(ie, se, de, "âˆ«", "\\intop"),
        ne(ie, se, de, "âˆ¬", "\\iint"),
        ne(ie, se, de, "âˆ­", "\\iiint"),
        ne(ie, se, de, "âˆ", "\\prod"),
        ne(ie, se, de, "âˆ‘", "\\sum"),
        ne(ie, se, de, "â¨‚", "\\bigotimes"),
        ne(ie, se, de, "â¨", "\\bigoplus"),
        ne(ie, se, de, "â¨€", "\\bigodot"),
        ne(ie, se, de, "âˆ®", "\\oint"),
        ne(ie, se, de, "âˆ¯", "\\oiint"),
        ne(ie, se, de, "âˆ°", "\\oiiint"),
        ne(ie, se, de, "â¨†", "\\bigsqcup"),
        ne(ie, se, de, "âˆ«", "\\smallint"),
        ne(oe, se, pe, "â€¦", "\\textellipsis"),
        ne(ie, se, pe, "â€¦", "\\mathellipsis"),
        ne(oe, se, pe, "â€¦", "\\ldots", !0),
        ne(ie, se, pe, "â€¦", "\\ldots", !0),
        ne(ie, se, pe, "â‹¯", "\\@cdots", !0),
        ne(ie, se, pe, "â‹±", "\\ddots", !0),
        ne(ie, se, ye, "â‹®", "\\varvdots"),
        ne(ie, se, he, "ËŠ", "\\acute"),
        ne(ie, se, he, "Ë‹", "\\grave"),
        ne(ie, se, he, "Â¨", "\\ddot"),
        ne(ie, se, he, "~", "\\tilde"),
        ne(ie, se, he, "Ë‰", "\\bar"),
        ...
        ne(ie, se, he, "âƒ—", "\\vec"),
        ne(ie, se, he, "Ë™", "\\dot"),
        ne(ie, se, he, "Ëš", "\\mathring"),
        ne(ie, se, ue, "î„±", "\\@imath"),
        ne(ie, se, ue, "îˆ·", "\\@jmath"),
        ne(ie, se, ye, "Ä±", "Ä±"),
        ne(ie, se, ye, "È·", "È·"),
        ne(oe, se, ye, "Ä±", "\\i", !0),
        ne(oe, se, ye, "È·", "\\j", !0),
        ...
        ne(oe, se, he, "Â¨", '\\"'),
        ne(oe, se, he, "Ë", "\\H"),
        ne(oe, se, he, "â—¯", "\\textcircled");
        var xe = { "--": !0, "---": !0, "``": !0, "''": !0 };
        ne(oe, se, ye, "â€“", "--", !0),
            ne(oe, se, ye, "â€“", "\\textendash"),
            ne(oe, se, ye, "â€”", "---", !0),
            ne(oe, se, ye, "â€”", "\\textemdash"),
            ne(oe, se, ye, "â€˜", "`", !0),
            ne(oe, se, ye, "â€˜", "\\textquoteleft"),
            ne(oe, se, ye, "â€™", "'", !0),
            ne(oe, se, ye, "â€™", "\\textquoteright"),
            ne(oe, se, ye, "â€œ", "``", !0),
            ne(oe, se, ye, "â€œ", "\\textquotedblleft"),
            ne(oe, se, ye, "â€", "''", !0),
            ne(oe, se, ye, "â€", "\\textquotedblright"),
            ne(ie, se, ye, "Â°", "\\degree", !0),
            ne(oe, se, ye, "Â°", "\\degree"),
            ne(oe, se, ye, "Â°", "\\textdegree", !0),
            ne(ie, se, ye, "Â£", "\\pounds"),
            ne(ie, se, ye, "Â£", "\\mathsterling", !0),
            ne(oe, se, ye, "Â£", "\\pounds"),
            ne(oe, se, ye, "Â£", "\\textsterling", !0),
            ne(ie, le, ye, "âœ ", "\\maltese"),
            ne(oe, le, ye, "âœ ", "\\maltese");
        for (var we = '0123456789/@."', ke = 0; ke < 14; ke++) {
            var Se = we.charAt(ke);
            ne(ie, se, ye, Se, Se);
        }
        for (var Me = '0123456789!@*()-=+";:?/.,', ze = 0; ze < 25; ze++) {
            var Ae = Me.charAt(ze);
            ne(oe, se, ye, Ae, Ae);
        }
        for (
            ...
            var Ce = Te.charAt(Be);
            ne(ie, se, ue, Ce, Ce), ne(oe, se, ye, Ce, Ce);
        }
        ne(ie, le, ye, "C", "â„‚"),
            ne(oe, le, ye, "C", "â„‚"),
            ne(ie, le, ye, "H", "â„"),
            ...
            ne(ie, se, ue, "h", "â„Ž"),
            ne(oe, se, ue, "h", "â„Ž");
        for (var Ne = "", qe = 0; qe < 52; qe++) {
            var Ie = Te.charAt(qe);
            ne(ie, se, ue, Ie, (Ne = String.fromCharCode(55349, 56320 + qe))),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    se,
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56372 + qe))
                ),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56424 + qe))
                ),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56580 + qe))
                ),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56736 + qe))
                ),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56788 + qe))
                ),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56840 + qe))
                ),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56944 + qe))
                ),
                ne(oe, se, ye, Ie, Ne),
            qe < 26 &&
            (ne(
                ...
                ue,
                Ie,
                (Ne = String.fromCharCode(55349, 56632 + qe))
            ),
                ne(oe, se, ye, Ie, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    Ie,
                    (Ne = String.fromCharCode(55349, 56476 + qe))
                ),
                ne(oe, se, ye, Ie, Ne));
        }
        ne(ie, se, ue, "k", (Ne = String.fromCharCode(55349, 56668))),
            ne(oe, se, ye, "k", Ne);
        for (var Re = 0; Re < 10; Re++) {
            var He = Re.toString();
            ne(ie, se, ue, He, (Ne = String.fromCharCode(55349, 57294 + Re))),
                ne(oe, se, ye, He, Ne),
                ne(
                    ie,
                    se,
                    ue,
                    He,
                    (Ne = String.fromCharCode(55349, 57314 + Re))
                ),
                ne(oe, se, ye, He, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    He,
                    (Ne = String.fromCharCode(55349, 57324 + Re))
                ),
                ne(oe, se, ye, He, Ne),
                ne(
                    ie,
                    ...
                    ue,
                    He,
                    (Ne = String.fromCharCode(55349, 57334 + Re))
                ),
                ne(oe, se, ye, He, Ne);
        }
        for (var Oe = "ÃÃžÃ¾", Ee = 0; Ee < 3; Ee++) {
            var Le = Oe.charAt(Ee);
            ne(ie, se, ue, Le, Le), ne(oe, se, ye, Le, Le);
        }
        var De = [
            ...
            Ve = function (e, t, r) {
                return (
                    ae[r][e] && ae[r][e].replace && (e = ae[r][e].replace),
                        { value: e, metrics: q(e, t, r) }
                );
            },
            Fe = function (e, t, r, a, n) {
                var i,
                    o = Ve(e, t, r),
                    s = o.metrics;
                if (((e = o.value), s)) {
            ...
            Ze = {
                    ...
                    return (
                        void 0 === a && (a = []),
                            "boldsymbol" === r.font && Ve(e, "Main-Bold", t).metrics
                                ? Fe(e, "Main-Bold", t, r, a.concat(["mathbf"]))
                                : "\\" === e || "main" === ae[t][e].font
                                    ? Fe(e, "Main-Regular", t, r, a)
                                    : Fe(e, "AMS-Regular", t, r, a.concat(["amsrm"]))
                    );
                },
                makeSpan: Ye,
                makeSvgSpan: Xe,
                makeLineSpan: function (e, t, r) {
                    ...
                    return (
                        (a.height = Math.max(
                            ...
                            (a.style.borderBottomWidth = F(a.height)),
                            (a.maxFontSize = 1),
                            a
                    );
                },
                ...
                wrapFragment: function (e, t) {
                    return e instanceof T ? Ye([], [e], t) : e;
                },
                makeVList: function (e, t) {
                    ...
                    for (
                        ...
                        if ("kern" === d.type) p += d.size;
                            ...
                            var g = d.elem,
                                ...
                                v = d.wrapperStyle || {},
                                b = Ye(f, [l, g], void 0, v);
                            (b.style.top = F(-n - p - g.depth)),
                            d.marginLeft &&
                            (b.style.marginLeft = d.marginLeft),
                            d.marginRight &&
                            (b.style.marginRight = d.marginRight),
                                h.push(b),
                                (p += g.height + g.depth);
                        }
                    ...
                    var y,
                        x = Ye(["vlist"], h);
                    if (((x.style.height = F(c)), m < 0)) {
                        var w = Ye([], []),
                            k = Ye(["vlist"], [w]);
                        k.style.height = F(-m);
                        var S = Ye(["vlist-s"], [new Z("â€‹")]);
                        y = [Ye(["vlist-r"], [x, S]), Ye(["vlist-r"], [k])];
                    } else y = [Ye(["vlist-r"], [x])];
                    var M = Ye(["vlist-t"], y);
                    return (
                        2 === y.length && M.classes.push("vlist-t2"),
                            (M.height = c),
                            (M.depth = -m),
                            M
                    );
                ...
                makeOrd: function (e, t, r) {
                    ...
                    if (l) {
                        ...
                        if ("boldsymbol" === l) {
                            var u = (function (e, t, r, a, n) {
                                return "textord" !== n &&
                                Ve(e, "Math-BoldItalic", t).metrics
                                    ? {
                            ...
                            s
                                ? ((c = je[l].fontName), (p = [l]))
                                : ((c = _e(l, t.fontWeight, t.fontShape)),
                                    (p = [l, t.fontWeight, t.fontShape]));
                        if (Ve(i, c, a).metrics)
                            return Fe(i, c, a, t, o.concat(p));
                        if (
                            xe.hasOwnProperty(i) &&
                            "Typewriter" === c.slice(0, 10)
                        ) {
                            for (var d = [], g = 0; g < i.length; g++)
                                d.push(Fe(i[g], c, a, t, o.concat(p)));
                            return We(d);
                        }
                    }
                    if ("mathord" === r)
                    ...
                    if ("textord" === r) {
                        var f = ae[a][i] && ae[a][i].font;
                        if ("ams" === f) {
                            var v = _e("amsrm", t.fontWeight, t.fontShape);
                            return Fe(
                                i,
                                v,
                                a,
                        ...
                        if ("main" !== f && f) {
                            var b = _e(f, t.fontWeight, t.fontShape);
                            return Fe(
                                i,
                                b,
                                a,
                                t,
                                o.concat(b, t.fontWeight, t.fontShape)
                            );
                        }
                        var y = _e("textrm", t.fontWeight, t.fontShape);
                        return Fe(
                            i,
                            y,
                            a,
                            t,
                            o.concat(t.fontWeight, t.fontShape)
                        );
                    }
                ...
                makeGlue: (e, t) => {
                    var r = Ye(["mspace"], [], t),
                        a = V(e, t);
                    return (r.style.marginRight = F(a)), r;
                },
            ...
            Qe = { number: 5, unit: "mu" },
            et = {
                mord: { mop: Ke, mbin: Je, mrel: Qe, minner: Ke },
                mop: { mord: Ke, mop: Ke, mrel: Qe, minner: Ke },
                mbin: { mord: Je, mop: Je, mopen: Je, minner: Je },
                mrel: { mord: Qe, mop: Qe, mopen: Qe, minner: Qe },
                mopen: {},
                mclose: { mop: Ke, mbin: Je, mrel: Qe, minner: Ke },
                mpunct: {
                    mord: Ke,
                    mop: Ke,
                    mrel: Qe,
            ...
            for (
                var {
                    ...
                    s = {
                        ...
                        allowedInMath:
                            void 0 === a.allowedInMath || a.allowedInMath,
        ...
        var st = function (e) {
            ...
            dt = function (e, t, r, a) {
                ...
                if ((Ze.tryCombineChars(n), !r)) return n;
                var l = t;
                if (1 === e.length) {
                    var m = e[0];
                    "sizing" === m.type
                        ? (l = t.havingSize(m.size))
                        : "styling" === m.type &&
                        (l = t.havingStyle(pt[m.style]));
                }
                var c = ht([a[0] || "leftmost"], [], t),
                    p = ht([a[1] || "rightmost"], [], t),
                    u = "root" === r;
                return (
                    gt(
                        n,
            ...
            bt = function (e, t) {
                return e
                    ? (t && (e = vt(e, t)), ut[e.classes[0]] || null)
                    : null;
            },
            yt = function (e, t) {
        ...
        function wt(e, t) {
            var r = ht(["base"], e, t),
                a = ht(["strut"]);
            return (
                (a.style.height = F(r.height + r.depth)),
                r.depth && (a.style.verticalAlign = F(-r.depth)),
        ...
        function kt(e, t) {
            ...
            for (var i, o = [], s = [], l = 0; l < n.length; l++)
                if (
                    ...
                    (s.pop(),
                    s.length > 0 && (o.push(wt(s, t)), (s = [])),
                        o.push(n[l]));
            s.length > 0 && o.push(wt(s, t)),
                r
                    ? (((i = wt(dt(r, t, !0))).classes = ["tag"]), o.push(i))
                    : a && o.push(a);
            var m = ht(["katex-html"], o);
            if ((m.setAttribute("aria-hidden", "true"), i)) {
                var c = i.children[0];
                (c.style.height = F(m.height + m.depth)),
                m.depth && (c.style.verticalAlign = F(-m.depth));
            }
            return m;
        }
        function St(e) {
            ...
            toMarkup() {
                ...
                for (var t in this.attributes)
                    ...
                    ((e += " " + t + '="'),
                        ...
                        (e += '"'));
                this.classes.length > 0 &&
                (e += ' class ="' + h.escape(G(this.classes)) + '"'),
                    (e += ">");
                for (var r = 0; r < this.children.length; r++)
                    e += this.children[r].toMarkup();
                return (e += "</" + this.type + ">");
        ...
        var At = {
            ...
            Ct = function (e, t) {
                ...
                var n = e.text;
                return h.contains(["\\imath", "\\jmath"], n)
                    ? null
                    : (ae[a][n] && ae[a][n].replace && (n = ae[a][n].replace),
                        q(n, Ze.fontMap[r].fontName, a)
                            ? Ze.fontMap[r].variant
                            : null);
            },
            Nt = function (e, t, r) {
                if (1 === e.length) {
                ...
                for (var n, i = [], o = 0; o < e.length; o++) {
                    var s = It(e[o], t);
                    if (s instanceof Mt && n instanceof Mt) {
                        if (
                            "mtext" === s.type &&
                            "mtext" === n.type &&
        ...
        function Rt(e, t, r, a, n) {
            ...
            i =
                1 === o.length &&
                o[0] instanceof Mt &&
                h.contains(["mrow", "mtable"], o[0].type)
                    ? o[0]
                    : new At.MathNode("mrow", o);
        ...
        var Ht = function (e) {
            ...
            Dt = function (e, t, r, a, n) {
                ...
                if (/fbox|color|angl/.test(t)) {
                    ...
                    i = Ze.makeSvgSpan([], [h], n);
                }
                return (i.height = o), (i.style.height = F(o)), i;
            },
            Pt = function (e) {
                var t = new At.MathNode("mo", [
                    new At.TextNode(Et[e.replace(/^\\/, "")]),
                ]);
                ...
                var { span: r, minWidth: a, height: n } = (function () {
                    ...
                    for (var k = 0; k < w; k++) {
                        var S = new J(v[k]),
                            ...
                            z = Ze.makeSvgSpan([p[k]], [M], t);
                        if (1 === w) return { span: z, minWidth: b, height: x };
                        (z.style.height = F(x)), g.push(z);
                    }
                    return {
                        span: Ze.makeSpan(["stretchy"], g, t),
                        minWidth: b,
                        height: x,
                    };
                })();
        ...
        var Yt = (e, t) => {
                ...
                var i = xt(r, t.havingCrampedStyle()),
                    o = 0;
                if (a.isShifty && h.isCharacterBox(r)) {
                    var s = h.getBaseElem(r);
                    o = ee(xt(s, t.havingCrampedStyle())).skew;
                }
                var l,
                    m = "\\c" === a.label,
                    c = m
            ...
            Xt = (e, t) => {
                var r = e.isStretchy
                        ? Pt(e.label)
                        : new At.MathNode("mo", [Tt(e.label, e.mode)]),
                    a = new At.MathNode("mover", [It(e.base, t), r]);
        ...
        it({
            ...
            it({
                ...
                mathmlBuilder: (e, t) => {
                    var r = Pt(e.label),
                        a = new At.MathNode("munder", [It(e.base, t), r]);
        ...
        it({
            ...
            htmlBuilder(e, t) {
                var r,
                    ...
                    i = Ze.wrapFragment(xt(e.body, n, t), t),
                ...
                return (
                    s.children[0].children[0].children[1].classes.push(
                        "svg-align"
                    ),
                        Ze.makeSpan(["mrel", "x-arrow"], [s], t)
                );
            },
            mathmlBuilder(e, t) {
                var r,
                ...
                if (
                    ...
                    if (e.below) {
                        ...
                        r = new At.MathNode("munderover", [a, i, n]);
                    } else r = new At.MathNode("mover", [a, n]);
                } else if (e.below) {
                    var o = _t(It(e.below, t));
                    r = new At.MathNode("munder", [a, o]);
                } else (r = _t()), (r = new At.MathNode("mover", [a, r]));
                return r;
            },
        });
        var jt = Ze.makeSpan;
        ...
        function Zt(e, t) {
            ...
            return (
                "minner" === e.mclass
                    ? (r = new At.MathNode("mpadded", a))
                    : "mord" === e.mclass
                        ? e.isCharacterBox
                            ? ((r = a[0]).type = "mi")
                            : (r = new At.MathNode("mi", a))
                        : (e.isCharacterBox
                            ? ((r = a[0]).type = "mo")
                            : (r = new At.MathNode("mo", a)),
                            "mbin" === e.mclass
        ...
        it({
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    var r = dt(e.body, t, !0),
                        a = Ze.makeSpan([e.mclass], r, t);
                    return (a.style.textShadow = "0.02em 0.01em 0.04px"), a;
                },
                mathmlBuilder(e, t) {
                    var r = Nt(e.body, t),
                        a = new At.MathNode("mstyle", r);
                    return (
                        a.setAttribute(
                            "style",
        ...
        it({
            ...
            htmlBuilder(e, t) {
                var r = t.havingStyle(t.style.sup()),
                    a = Ze.wrapFragment(xt(e.label, r, t), t);
                return (
                    a.classes.push("cd-label-" + e.side),
                        (a.style.bottom = F(0.8 - a.depth)),
                        (a.height = 0),
                        (a.depth = 0),
                        a
                );
            ...
            mathmlBuilder(e, t) {
                var r = new At.MathNode("mrow", [It(e.label, t)]);
                return (
                    (r = new At.MathNode("mpadded", [r])).setAttribute(
                        "width",
                        "0"
                    ),
                    "left" === e.side && r.setAttribute("lspace", "-1width"),
                        r.setAttribute("voffset", "0.7em"),
                        (r = new At.MathNode("mstyle", [r])).setAttribute(
                            "displaystyle",
                            "false"
                        ),
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    var r = Ze.wrapFragment(xt(e.fragment, t), t);
                    return r.classes.push("cd-vert-arrow"), r;
                },
                mathmlBuilder(e, t) {
                    return new At.MathNode("mrow", [It(e.fragment, t)]);
                },
            }),
            it({
                type: "textord",
        ...
        it({
            ...
            handler(e, t) {
                var { parser: r } = e,
                    ...
                    n = t[1];
                return { type: "color", mode: r.mode, color: a, body: lt(n) };
            },
            htmlBuilder: tr,
            mathmlBuilder: rr,
        }),
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    ...
                    return (
                        ...
                        e.size && (r.style.marginTop = F(V(e.size, t)))),
                            r
                    );
                },
                mathmlBuilder(e, t) {
                    ...
                    return (
                        ...
                        e.size &&
                        r.setAttribute("height", F(V(e.size, t)))),
                            r
                    );
                },
            });
        ...
        var or = function (e, t, r) {
                var a = q((ae.math[e] && ae.math[e].replace) || e, t, r);
                if (!a)
                    throw new Error(
            ...
            sr = function (e, t, r, a) {
                var n = r.havingBaseStyle(t),
                    i = Ze.makeSpan(a.concat(n.sizingClasses(r)), [e], r),
            ...
            hr = function (e, t, r, a, n, i) {
                var o = (function (e, t, r, a) {
                        return Ze.makeSymbol(e, "Size" + t + "-Regular", r, a);
                    })(e, t, n, a),
                    s = sr(
                        Ze.makeSpan(["delimsizing", "size" + t], [o], a),
                        w.TEXT,
                        a,
                        i
                    );
                return r && lr(s, a, w.TEXT), s;
            },
            mr = function (e, t, r) {
                var a;
                return (
                    (a = "Size1-Regular" === t ? "delim-size1" : "delim-size4"),
                        {
                            ...
                            elem: Ze.makeSpan(
                                ["delimsizinginner", a],
                                [Ze.makeSpan([], [Ze.makeSymbol(e, t, r)])]
                            ),
                        }
                );
            },
            cr = function (e, t, r) {
                var a = B["Size4-Regular"][e.charCodeAt(0)]
                        ? B["Size4-Regular"][e.charCodeAt(0)][4]
                        : B["Size1-Regular"][e.charCodeAt(0)][4],
                    n = new J(
                        "inner",
                        (function (e, t) {
                            switch (e) {
            ...
            gr = function (e, t, r, a, n, i) {
                    ...
                    : "\\Uparrow" === e
                        ...
                        : "\\downarrow" === e
                            ...
                            : "\\Downarrow" === e
                                ? (o = l = "â€–")
                                : "\\updownarrow" === e
                                    ? ((o = "\\uparrow"), (l = "â"), (m = "\\downarrow"))
                                    : "\\Updownarrow" === e
                                        ? ((o = "\\Uparrow"), (l = "â€–"), (m = "\\Downarrow"))
                                        : h.contains(ur, e)
                                            ? ((l = "âˆ£"), (c = "vert"), (p = 333))
                                            : h.contains(dr, e)
                                                ? ((l = "âˆ¥"), (c = "doublevert"), (p = 556))
                                                : "[" === e || "\\lbrack" === e
                                                    ? ((o = "âŽ¡"),
                                                        (l = "âŽ¢"),
                                                        (m = "âŽ£"),
                ...
                if (c.length > 0) {
                    var C = z - g - y,
                        ...
                        E = Ze.makeSvgSpan([], [O], a);
                    (E.height = N / 1e3),
                        (E.style.width = R),
                        (E.style.height = H),
                        B.push({ type: "elem", elem: E });
                } else {
                    if ((B.push(mr(m, u, n)), B.push(pr), null === s)) {
                        var L = z - g - y + 0.016;
                        B.push(cr(l, L, a));
                    } else {
                ...
                var P = a.havingBaseStyle(w.TEXT),
                    V = Ze.makeVList(
                        {
                            positionType: "bottom",
                            positionData: T,
                ...
                return sr(
                    Ze.makeSpan(["delimsizing", "mult"], [V], P),
                    w.TEXT,
                    a,
                    i
                );
            ...
            vr = function (e, t, r, a, n) {
                ...
                return Ze.makeSvgSpan(["hide-tail"], [s], n);
            },
            br = [
                "(",
                "\\lparen",
            ...
            Tr = function (e, t, r, a, n, i) {
                ...
                "<" === e || "\\lt" === e || "âŸ¨" === e
                    ...
                    : (">" !== e && "\\gt" !== e && "âŸ©" !== e) ||
                    (e = "\\rangle"),
                    (o = h.contains(xr, e) ? kr : h.contains(br, e) ? Mr : Sr);
                var s = Ar(e, t, o, a);
                return "small" === s.type
                    ? (function (e, t, r, a, n, i) {
                        var o = Ze.makeSymbol(e, "Main-Regular", n, a),
                            s = sr(o, t, a, i);
                        return r && lr(s, a, t), s;
                    })(e, s.style, r, a, n, i)
                    : "large" === s.type
                ...
                sqrtImage: function (e, t) {
                    var r,
                        ...
                        s = Math.max(
                            0,
                            t.minRuleThickness -
                            t.fontMetrics().sqrtRuleThickness
                        ),
                        l = 0,
                        h = 0,
                        m = 0;
                        ...
                        "small" === i.type
                            ...
                            : "large" === i.type
                                ...
                                : ((l = e + s + fr),
                                    ...
                                    ((r = vr("sqrtTall", l, m, s, t)).style.minWidth =
                                        "0.742em"),
                                    (a = 1.056)),
                            (r.height = h),
                            (r.style.height = F(l)),
                            {
                                ...
                                advanceWidth: a,
                                ruleWidth:
                                    (t.fontMetrics().sqrtRuleThickness + s) * o,
                            }
                    );
                },
                sizedDelim: function (e, t, r, a, i) {
                    if (
                        ("<" === e || "\\lt" === e || "âŸ¨" === e
                            ...
                            : (">" !== e && "\\gt" !== e && "âŸ©" !== e) ||
                            (e = "\\rangle"),
                        h.contains(br, e) || h.contains(xr, e))
                    )
                        return hr(e, t, !1, r, a, i);
                    if (h.contains(yr, e)) return gr(e, wr[t], !1, r, a, i);
        ...
        function qr(e, t) {
            var r = Ut(e);
            if (r && h.contains(Nr, r.text)) return r;
            throw new n(
                r
                    ? "Invalid delimiter '" +
                    r.text +
        ...
        it({
            ...
            mathmlBuilder: (e) => {
                ...
                var a = F(Br.sizeToMaxHeight[e.size]);
                return (
            ...
            it({
                ...
                htmlBuilder: (e, t) => {
                    ...
                    if (
                        ((i *= t.sizeMultiplier),
                            ...
                            (r =
                                "." === e.left
                                    ? yt(t, ["mopen"])
                                    : Br.leftRightDelim(e.left, i, o, t, e.mode, [
                                        "mopen",
                                    ])),
                            n.unshift(r),
                            s)
                    ...
                    if ("." === e.right) a = yt(t, ["mclose"]);
                    else {
                        var c = e.rightColor ? t.withColor(e.rightColor) : t;
                        a = Br.leftRightDelim(e.right, i, o, c, e.mode, [
                            "mclose",
                        ]);
                    }
                    return n.push(a), Ze.makeSpan(["minner"], n, t);
                },
                mathmlBuilder: (e, t) => {
                    Ir(e);
                    var r = Nt(e.body, t);
                    if ("." !== e.left) {
                        var a = new At.MathNode("mo", [Tt(e.left, e.mode)]);
                        a.setAttribute("fence", "true"), r.unshift(a);
                    }
                    if ("." !== e.right) {
                        var n = new At.MathNode("mo", [Tt(e.right, e.mode)]);
        ...
        var Rr = (e, t) => {
                var r,
                    a,
                    n,
                    i = Ze.wrapFragment(xt(e.body, t), t),
                    o = e.label.slice(1),
                    s = t.sizeMultiplier,
                    l = 0,
                    m = h.isCharacterBox(e.body);
                if ("sout" === o)
                    ((r = Ze.makeSpan(["stretchy", "sout"])).height =
                    ...
                    /box/.test(o)
                        ...
                        /fbox|boxed|fcolorbox/.test(o)
                            ? ((r.style.borderStyle = "solid"),
                                (r.style.borderWidth = F(y)))
                            : "angl" === o &&
                            0.049 !== y &&
                            ((r.style.borderTopWidth = F(y)),
                ...
                return (
                    /cancel/.test(o) &&
                    ((n.height = i.height), (n.depth = i.depth)),
                        /cancel/.test(o) && !m
                            ? Ze.makeSpan(["mord", "cancel-lap"], [n], t)
                            : Ze.makeSpan(["mord"], [n], t)
                );
            },
            Hr = (e, t) => {
                var r = 0,
                    a = new At.MathNode(
                        e.label.indexOf("colorbox") > -1
                            ? "mpadded"
                            : "menclose",
                        [It(e.body, t)]
                    );
        ...
        function Gr(e, t, r) {
            ...
            if (
                ...
                if (null == g) l = 1;
                    ...
                    throw new n("Invalid \\arraystretch: " + g);
            }
            e.gullet.beginGroup();
            var f = [],
                v = [f],
            ...
            function k() {
                ...
                (e.gullet.macros.get("\\df@tag")
                    ? (x.push(e.subparse([new a("\\df@tag")])),
        ...
        var Yr = function (e, t) {
                ...
                if (e.tags && e.tags.some((e) => e))
                    for (r = 0; r < i; ++r) {
                        ...
                        ((D =
                            !0 === L
                                ? Ze.makeSpan(["eqn-num"], [], t)
                                : !1 === L
                                    ? Ze.makeSpan([], [], t)
                                    : Ze.makeSpan([], dt(L, t, !0), t)).depth =
                            O.depth),
                            (D.height = O.height),
                            H.push({ type: "elem", elem: D, shift: E });
                    }
                for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
                    for (var P = I[N] || {}, G = !0; "separator" === P.type; ) {
                        if (
                            (G ||
                            (((C = Ze.makeSpan(
                                ["arraycolsep"],
                        ...
                        var U = "|" === P.separator ? "solid" : "dashed",
                            Y = Ze.makeSpan(["vertical-separator"], [], t);
                        (Y.style.height = F(y)),
                            (Y.style.borderRightWidth = F(c)),
                            (Y.style.borderRightStyle = U),
                            (Y.style.margin = "0 " + F(-c / 2));
                        var X = y - q;
                ...
                if (((l = Ze.makeSpan(["mtable"], R)), m.length > 0)) {
                    for (
                        var K = Ze.makeLineSpan("hline", t, c),
                            J = Ze.makeLineSpan("hdashline", t, c),
                ...
                if (0 === H.length) return Ze.makeSpan(["mord"], [l], t);
                var re = Ze.makeVList(
                    { positionType: "individualShift", children: H },
                    t
                );
                return (
                    (re = Ze.makeSpan(["tag"], [re], t)),
                        Ze.makeFragment([l, re])
                );
            },
            ...
            Wr = function (e, t) {
                for (
                    var r = [],
                        a = new At.MathNode("mtd", [], ["mtr-glue"]),
                        n = new At.MathNode("mtd", [], ["mml-eqn-num"]),
                        i = 0;
                    i < e.body.length;
                    i++
                ) {
                    for (var o = e.body[i], s = [], l = 0; l < o.length; l++)
                        s.push(new At.MathNode("mtd", [It(o[l], t)]));
                    e.tags &&
                    e.tags[i] &&
                    (s.unshift(a),
                        s.push(a),
                        e.leqno ? s.unshift(n) : s.push(n)),
                        r.push(new At.MathNode("mtr", s));
                }
                var h = new At.MathNode("mtable", r),
                    m =
                        0.5 === e.arraystretch
                            ? 0.1
                            : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
                h.setAttribute("rowspacing", F(m));
                var c = "",
                    p = "";
                ...
                return (
                    ...
                    "" !== c &&
                    (h = new At.MathNode("menclose", [h])).setAttribute(
                        "notation",
                        c.trim()
                    ),
                    e.arraystretch &&
                    e.arraystretch < 1 &&
                    (h = new At.MathNode("mstyle", [h])).setAttribute(
                        "scriptlevel",
                        "1"
                    ),
                        h
            ...
            _r = function (e, t) {
                ...
                s.body.forEach(function (e) {
                    for (var t = 1; t < e.length; t += 2) {
                        ...
                        Ft(a.body[0], "ordgroup").body.unshift(h);
                    }
        ...
        Er({
            ...
            props: { numArgs: 1 },
            handler(e, t) {
                var r = (Ut(t[0]) ? [t[0]] : Ft(t[0], "ordgroup").body).map(
                        function (e) {
                            var t = Gt(e).text;
                            if (-1 !== "lcr".indexOf(t))
            ...
            Er({
                ...
                handler(e, t) {
                    ...
                    if (
                        (a = Gr(e.parser, a, "script")).body.length > 0 &&
                        a.body[0].length > 1
                    )
                        throw new n("{subarray} can contain only one column");
                    return a;
            ...
            Er({
                ...
                props: { numArgs: 0 },
                handler(e) {
                    h.contains(["gather", "gather*"], e.envName) && Vr(e);
                    var t = {
        ...
        it({
            ...
            handler(e, t) {
                ...
                if ("\\begin" === a) {
                    ...
                    r.expect("\\end", !1);
                    var u = r.nextToken,
                        d = Ft(r.parseFunction(), "environment");
                    if (d.name !== o)
                        throw new n(
                            "Mismatch: \\begin{" +
                            o +
            ...
            Qr = (e, t) => {
                ...
                if (
                    (e.hasBarLine
                        ? (e.barSize
                            ? ((m = V(e.barSize, t)),
                                (h = Ze.makeLineSpan("frac-line", t, m)))
                            : (h = Ze.makeLineSpan("frac-line", t)),
                            (m = h.height),
                            (c = h.height))
                        : ((h = null),
                            (m = 0),
                            (c = t.fontMetrics().defaultRuleThickness)),
                        a.size === w.DISPLAY.size || "display" === e.size
                ...
                return (
                    (r = t.havingStyle(a)),
                        ...
                        Ze.makeSpan(
                            ...
                            [v, Ze.makeSpan(["mfrac"], [g]), b],
                            t
                        )
                );
            },
            ea = (e, t) => {
                var r = new At.MathNode("mfrac", [
                    It(e.numer, t),
                    It(e.denom, t),
                ]);
                if (e.hasBarLine) {
                    if (e.barSize) {
                        var a = V(e.barSize, t);
                        r.setAttribute("linethickness", F(a));
                    }
                ...
                if (null != e.leftDelim || null != e.rightDelim) {
                    var o = [];
                    if (null != e.leftDelim) {
                        var s = new At.MathNode("mo", [
                            new At.TextNode(e.leftDelim.replace("\\", "")),
                        ]);
                        s.setAttribute("fence", "true"), o.push(s);
                    }
                    if ((o.push(r), null != e.rightDelim)) {
                        var l = new At.MathNode("mo", [
                            new At.TextNode(e.rightDelim.replace("\\", "")),
                        ]);
        ...
        it({
            ...
            handler(e, t) {
                var r,
                    ...
                    o = st(t[0]),
                    s =
                        "atom" === o.type && "open" === o.family
                            ? ra(o.text)
                            : null,
                    l = st(t[1]),
                    h =
                        "atom" === l.type && "close" === l.family
                            ? ra(l.text)
                            : null,
                    m = Ft(t[2], "size"),
                    c = null;
        ...
        var aa = (e, t) => {
            ...
            "supsub" === e.type
                ? ((r = e.sup
                    ? xt(e.sup, t.havingStyle(n.sup()), t)
                    : xt(e.sub, t.havingStyle(n.sub()), t)),
                    (a = Ft(e.base, "horizBrace")))
                : (a = Ft(e, "horizBrace"));
            var i,
                o = xt(a.base, t.havingBaseStyle(w.DISPLAY)),
                s = Vt(a, t);
            if (
                (a.isOver
                    ? (i = Ze.makeVList(
            ...
            return Ze.makeSpan(["mord", a.isOver ? "mover" : "munder"], [i], t);
        };
        it({
            type: "horizBrace",
            ...
            mathmlBuilder: (e, t) => {
                var r = Pt(e.label);
                return new At.MathNode(e.isOver ? "mover" : "munder", [
                    It(e.base, t),
                    r,
                ]);
            },
            ...
            it({
                ...
                handler: (e, t) => {
                    ...
                    return r.settings.isTrusted({ command: "\\href", url: n })
                        ? { type: "href", mode: r.mode, href: n, body: lt(a) }
                ...
                mathmlBuilder: (e, t) => {
                    var r = qt(e.body, t);
                    return (
                        r instanceof Mt || (r = new Mt("mrow", [r])),
            ...
            it({
                ...
                handler: (e, t) => {
                    ...
                    return { type: "href", mode: r.mode, href: a, body: lt(s) };
                },
            }),
            it({
                type: "hbox",
                ...
                handler(e, t) {
                    var { parser: r } = e;
                    return { type: "hbox", mode: r.mode, body: lt(t[0]) };
                },
                htmlBuilder(e, t) {
                    var r = dt(e.body, t, !1);
                    return Ze.makeFragment(r);
                ...
                mathmlBuilder(e, t) {
                    return new At.MathNode("mrow", Nt(e.body, t));
                },
            }),
            it({
                type: "html",
        ...
        it({
            ...
            htmlBuilder: (e, t) => {
                ...
                var i = { height: F(r + a) };
                n > 0 && (i.width = F(n)), a > 0 && (i.verticalAlign = F(-a));
            ...
            mathmlBuilder: (e, t) => {
                ...
                if (
                    ...
                    ((n = V(e.totalheight, t) - a),
                        r.setAttribute("valign", F(-n))),
                        r.setAttribute("height", F(a + n)),
                    e.width.number > 0)
                ) {
                    var i = V(e.width, t);
            ...
            it({
                ...
                htmlBuilder: (e, t) => {
                    var r;
                    "clap" === e.alignment
                        ? ((r = Ze.makeSpan([], [xt(e.body, t)])),
                            (r = Ze.makeSpan(["inner"], [r], t)))
                        : (r = Ze.makeSpan(["inner"], [xt(e.body, t)]));
                    var a = Ze.makeSpan(["fix"], []),
                        n = Ze.makeSpan([e.alignment], [r, a], t),
                        i = Ze.makeSpan(["strut"]);
                    return (
                        (i.style.height = F(n.height + n.depth)),
                        n.depth && (i.style.verticalAlign = F(-n.depth)),
                            n.children.unshift(i),
                            (n = Ze.makeSpan(["thinbox"], [n], t)),
                            Ze.makeSpan(["mord", "vbox"], [n], t)
                    );
                },
                mathmlBuilder: (e, t) => {
        ...
        var oa = (e, t, r, a, n, i, o) => {
                ...
                var s,
                    l,
                    m,
                    c = r && h.isCharacterBox(r);
                if (t) {
                    var p = xt(t, a.havingStyle(n.sup()), a);
                    l = {
                        elem: p,
                        kern: Math.max(
                ...
                if (r) {
                    var u = xt(r, a.havingStyle(n.sub()), a);
                    s = {
                        elem: u,
                        kern: Math.max(
                ...
                var v = [m];
                if (s && 0 !== i && !c) {
                    var b = Ze.makeSpan(["mspace"], [], a);
                    (b.style.marginRight = F(i)), v.unshift(b);
                }
                return Ze.makeSpan(["mop", "op-limits"], v, a);
            },
            sa = ["\\smallint"],
            la = (e, t) => {
                var r,
                ...
                if (
                    ...
                    if (
                        ...
                        ((c = n.name.slice(1)),
                            (n.name = "oiint" === c ? "\\iint" : "\\iiint")),
                            (o = Ze.makeSymbol(n.name, m, "math", t, [
                                "mop",
                                "op-symbol",
                                l ? "large-op" : "small-op",
                            ])),
                    ...
                    1 === d.length && d[0] instanceof Z
                        ? ((o = d[0]).classes[0] = "mop")
                        : (o = Ze.makeSpan(["mop"], d, t));
                } else {
                    for (var g = [], f = 1; f < n.name.length; f++)
                        g.push(Ze.mathsym(n.name[f], n.mode, t));
                    o = Ze.makeSpan(["mop"], g, t);
                }
                var v = 0,
                    b = 0;
                return (
            ...
            ha = (e, t) => {
                var r;
                if (e.symbol)
                    (r = new Mt("mo", [Tt(e.name, e.mode)])),
                    h.contains(sa, e.name) &&
                    r.setAttribute("largeop", "false");
                else if (e.body) r = new Mt("mo", Nt(e.body, t));
                else {
                    r = new Mt("mi", [new zt(e.name.slice(1))]);
                    var a = new Mt("mo", [Tt("â¡", "text")]);
                    r = e.parentIsSupSub ? new Mt("mrow", [r, a]) : St([r, a]);
                }
                return r;
            },
            ma = {
        ...
        it({
            ...
            mathmlBuilder: (e, t) => {
                for (
                    var r = Nt(e.body, t.withFont("mathrm")), a = !0, n = 0;
                    n < r.length;
                    n++
                ) {
                    var i = r[n];
                    if (i instanceof At.SpaceNode);
                    else if (i instanceof At.MathNode)
                        switch (i.type) {
                            case "mi":
                            case "mn":
                            case "ms":
                ...
                var h = new At.MathNode("mo", [Tt("â¡", "text")]);
                return e.parentIsSupSub
                    ? new At.MathNode("mrow", [l, h])
                    : At.newDocumentFragment([l, h]);
            },
        }),
            Dr(
                "\\operatorname",
            ...
            ot({
                ...
                htmlBuilder(e, t) {
                    return e.semisimple
                        ? Ze.makeFragment(dt(e.body, t, !1))
                        : Ze.makeSpan(["mord"], dt(e.body, t, !0), t);
                },
                mathmlBuilder(e, t) {
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    var r = xt(e.body, t.havingCrampedStyle()),
                        a = Ze.makeLineSpan("overline-line", t),
                ...
                mathmlBuilder(e, t) {
                    var r = new At.MathNode("mo", [new At.TextNode("â€¾")]);
                    r.setAttribute("stretchy", "true");
                    var a = new At.MathNode("mover", [It(e.body, t), r]);
                    return a.setAttribute("accent", "true"), a;
                },
            }),
            it({
                ...
                handler: (e, t) => {
                    var { parser: r } = e,
                        a = t[0];
                    return { type: "phantom", mode: r.mode, body: lt(a) };
                },
                htmlBuilder: (e, t) => {
            ...
            it({
                ...
                htmlBuilder: (e, t) => {
                    var r = Ze.makeSpan([], [xt(e.body, t.withPhantom())]);
                    ...
                    return (
                        (r = Ze.makeVList(
                            ...
                            Ze.makeSpan(["mord"], [r], t)
                    );
                },
                mathmlBuilder: (e, t) => {
                    var r = Nt(lt(e.body), t),
                        a = new At.MathNode("mphantom", r),
                        n = new At.MathNode("mpadded", [a]);
                    return (
            ...
            it({
                ...
                htmlBuilder: (e, t) => {
                    var r = Ze.makeSpan(
                            ["inner"],
                            [xt(e.body, t.withPhantom())]
                        ),
                        a = Ze.makeSpan(["fix"], []);
                    return Ze.makeSpan(["mord", "rlap"], [r, a], t);
                },
                mathmlBuilder: (e, t) => {
                    var r = Nt(lt(e.body), t),
                        a = new At.MathNode("mphantom", r),
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    ...
                    return (
                        (r.style.borderRightWidth = F(a)),
                            (r.style.borderTopWidth = F(n)),
                            (r.style.bottom = F(i)),
                            (r.width = a),
                            (r.height = n + i),
                            (r.depth = -i),
                ...
                mathmlBuilder(e, t) {
                    ...
                    o.setAttribute("mathbackground", i),
                        ...
                        o.setAttribute("height", F(a));
                    var s = new At.MathNode("mpadded", [o]);
                    return (
                        n >= 0
                            ? s.setAttribute("height", F(n))
                            : (s.setAttribute("height", F(n)),
                                s.setAttribute("depth", F(-n))),
                            s.setAttribute("voffset", F(n)),
                            s
                    );
                },
            });
        ...
        it({
            ...
            mathmlBuilder: (e, t) => {
                var r = t.havingSize(e.size),
                    a = Nt(e.body, r),
                    n = new At.MathNode("mstyle", a);
                return n.setAttribute("mathsize", F(r.sizeMultiplier)), n;
            },
        }),
            it({
                type: "smash",
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    ...
                    0 === r.height && (r.height = t.fontMetrics().xHeight),
                        (r = Ze.wrapFragment(r, t));
                    var a = t.fontMetrics().defaultRuleThickness,
                        n = a;
                    t.style.id < w.TEXT.id && (n = t.fontMetrics().xHeight);
                    var i = a + n / 4,
                    ...
                    if (e.index) {
                        var u = t.havingStyle(w.SCRIPTSCRIPT),
                            d = xt(e.index, u, t),
                            ...
                            v = Ze.makeSpan(["root"], [f]);
                        return Ze.makeSpan(["mord", "sqrt"], [v, p], t);
                    }
                ...
                mathmlBuilder(e, t) {
                    ...
                    return a
                        ? new At.MathNode("mroot", [It(r, t), It(a, t)])
                        : new At.MathNode("msqrt", [It(r, t)]);
                },
            });
        var ga = {
            display: w.DISPLAY,
        ...
        ot({
            ...
            htmlBuilder(e, t) {
                ...
                if (a && n) {
                    ...
                    v = Ze.makeVList(
                        { positionType: "shift", positionData: u, children: A },
                        t
                    );
                } else {
                    if (!a)
                        ...
                        (v = Ze.makeVList(
                            {
                                ...
                                positionData: -p,
                                children: [
                                    { type: "elem", elem: a, marginRight: y },
                                ],
                            },
                            t
                        ));
                }
                var T = bt(m, "right") || "mord";
                return Ze.makeSpan([T], [m, Ze.makeSpan(["msupsub"], [v])], t);
            },
            mathmlBuilder(e, t) {
                var r,
                    a = !1;
                ...
                var n,
                    i = [It(e.base, t)];
                if (
                    (e.sub && i.push(It(e.sub, t)),
                    e.sup && i.push(It(e.sup, t)),
                        a)
                )
                    n = r ? "mover" : "munder";
                else if (e.sub)
                    ...
                    n =
                        (l &&
                            "op" === l.type &&
                            l.limits &&
                            (t.style === w.DISPLAY || l.alwaysHandleSupSub)) ||
                        (l &&
                            "operatorname" === l.type &&
                            l.alwaysHandleSupSub &&
                            (l.limits || t.style === w.DISPLAY))
                            ? "mover"
                            : "msup";
                }
                return new At.MathNode(n, i);
            },
        }),
            ot({
                type: "atom",
        ...
        ot({
            ...
            ot({
                ...
                mathmlBuilder(e, t) {
                    var r,
                        a = Tt(e.text, e.mode, t),
                        n = Ct(e, t) || "normal";
                    return (
                        (r =
                            "text" === e.mode
                                ? new At.MathNode("mtext", [a])
                                : /[0-9]/.test(e.text)
                                    ? new At.MathNode("mn", [a])
                                    : "\\prime" === e.text
                                        ? new At.MathNode("mo", [a])
                                        : new At.MathNode("mi", [a])),
        ...
        ot({
            ...
            htmlBuilder(e, t) {
                if (ba.hasOwnProperty(e.text)) {
                    var r = ba[e.text].className || "";
                    if ("text" === e.mode) {
                        var a = Ze.makeOrd(e, t, "textord");
                        return a.classes.push(r), a;
                    }
                    return Ze.makeSpan(
                        ["mspace", r],
                        [Ze.mathsym(e.text, e.mode, t)],
                        t
                    );
                }
                if (va.hasOwnProperty(e.text))
                    return Ze.makeSpan(["mspace", va[e.text]], [], t);
                throw new n('Unknown type of space "' + e.text + '"');
            },
            mathmlBuilder(e, t) {
                if (!ba.hasOwnProperty(e.text)) {
                    if (va.hasOwnProperty(e.text))
                        return new At.MathNode("mspace");
                    throw new n('Unknown type of space "' + e.text + '"');
                }
                return new At.MathNode("mtext", [new At.TextNode("Â ")]);
            },
        });
        var ya = () => {
        ...
        ot({
            type: "tag",
            mathmlBuilder(e, t) {
                var r = new At.MathNode("mtable", [
                    new At.MathNode("mtr", [
                        ya(),
                        new At.MathNode("mtd", [qt(e.body, t)]),
                        ya(),
                        new At.MathNode("mtd", [qt(e.tag, t)]),
                    ]),
                ]);
        ...
        it({
            ...
            handler(e, t) {
                var { parser: r, funcName: a } = e,
                    n = t[0];
                return { type: "text", mode: r.mode, body: lt(n), font: a };
            },
            htmlBuilder(e, t) {
                var r = Sa(e, t),
                    a = dt(e.body, r, !0);
                return Ze.makeSpan(["mord", "text"], a, r);
            },
            mathmlBuilder(e, t) {
                var r = Sa(e, t);
                return qt(e.body, r);
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    var r = xt(e.body, t),
                        a = Ze.makeLineSpan("underline-line", t),
                        n = t.fontMetrics().defaultRuleThickness,
                        i = Ze.makeVList(
                            {
                                positionType: "top",
                ...
                mathmlBuilder(e, t) {
                    var r = new At.MathNode("mo", [new At.TextNode("â€¾")]);
                    r.setAttribute("stretchy", "true");
                    var a = new At.MathNode("munder", [It(e.body, t), r]);
                    return a.setAttribute("accentunder", "true"), a;
                },
            }),
            it({
            ...
            it({
                ...
                htmlBuilder(e, t) {
                    ...
                    return Ze.makeSpan(
                        ...
                        Ze.tryCombineChars(a),
                        n
                    );
                },
                mathmlBuilder(e, t) {
                    var r = new At.TextNode(Ma(e)),
                        a = new At.MathNode("mtext", [r]);
                    return a.setAttribute("mathvariant", "monospace"), a;
                },
            });
        var Ma = (e) => e.body.replace(/ /g, e.star ? "â£" : "Â "),
            za = rt,
            Aa = "[ \r\n\t]",
            Ta = "(\\\\[a-zA-Z@]+)" + Aa + "*",
            Ba = "[Ì€-Í¯]",
        ...
        class qa {
            ...
            lex() {
                ...
                if (t === e.length) return new a("EOF", new r(this, t, t));
                var i = this.tokenRegex.exec(e);
                if (null === i || i.index !== t)
                    throw new n(
                        "Unexpected character: '" + e[t] + "'",
                        new a(e[t], new r(this, t, t + 1))
                    );
                var o = i[6] || i[3] || (i[2] ? "\\ " : " ");
                ...
                return new a(o, new r(this, t, this.tokenRegex.lastIndex));
            }
        }
        class Ia {
            constructor(e, t) {
        ...
        Dr("\\char", function (e) {
            ...
            if (t) {
                if (null == (a = Ha[r.text]) || a >= t)
                    throw new n("Invalid base-" + t + " digit " + r.text);
                for (var i; null != (i = Ha[e.future().text]) && i < t; )
                    (a *= t), (a += i), e.popToken();
            }
            return "\\@char{" + a + "}";
        });
        ...
        Dr("\\newcommand", (e) => Oa(e, !1, !0)),
            Dr("\\renewcommand", (e) => Oa(e, !0, !1)),
            Dr("\\providecommand", (e) => Oa(e, !0, !0)),
            Dr("\\message", (e) => {
            ...
            Dr("\\aa", "\\r a"),
            Dr("\\AA", "\\r A"),
            Dr("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`Â©}"),
            Dr(
                "\\copyright",
            ...
            Dr("\\vdots", "\\mathord{\\varvdots\\rule{0pt}{15pt}}"),
            Dr("â‹®", "\\vdots"),
        ...
        Dr("\\dots", function (e) {
            ...
            return (
                r in Ea
                    ...
                    : ("\\not" === r.slice(0, 4) ||
                        (r in ae.math &&
                            h.contains(["bin", "rel"], ae.math[r].group))) &&
                    (t = "\\dotsb"),
                    t
            );
        });
        ...
        var Da = F(
            B["Main-Regular"]["T".charCodeAt(0)][1] -
            0.7 * B["Main-Regular"]["A".charCodeAt(0)][1]
        );
        Dr(
            "\\LaTeX",
            ...
            Dr("\\gvertneqq", "\\html@mathml{\\@gvertneqq}{â‰©}"),
            Dr("\\lvertneqq", "\\html@mathml{\\@lvertneqq}{â‰¨}"),
            ...
            Dr("\\varsubsetneq", "\\html@mathml{\\@varsubsetneq}{âŠŠ}"),
            Dr("\\varsubsetneqq", "\\html@mathml{\\@varsubsetneqq}{â«‹}"),
            Dr("\\varsupsetneq", "\\html@mathml{\\@varsupsetneq}{âŠ‹}"),
            Dr("\\varsupsetneqq", "\\html@mathml{\\@varsupsetneqq}{â«Œ}"),
            Dr("\\imath", "\\html@mathml{\\@imath}{Ä±}"),
            Dr("\\jmath", "\\html@mathml{\\@jmath}{È·}"),
            Dr(
                "\\llbracket",
                ...
                if ("string" == typeof a) {
                    ...
                    if (-1 !== a.indexOf("#"))
                        for (
                            ...
                            ++n;
                    for (
                        var o = new qa(a, this.settings), s = [], l = o.lex();
                        "EOF" !== l.text;
        ...
        var Ga = /^[â‚Šâ‚‹â‚Œâ‚â‚Žâ‚€â‚â‚‚â‚ƒâ‚„â‚…â‚†â‚‡â‚ˆâ‚‰â‚â‚‘â‚•áµ¢â±¼â‚–â‚—â‚˜â‚™â‚’â‚šáµ£â‚›â‚œáµ¤áµ¥â‚“áµ¦áµ§áµ¨áµ©áµª]/,
            Ua = Object.freeze({
                "â‚Š": "+",
                "â‚‹": "-",
                "â‚Œ": "=",
        ...
        class Wa {
                ...
                for (;;) {
                    ...
                    if ("\\limits" === i.text || "\\nolimits" === i.text) {
                        ...
                        for (this.consume(); ; ) {
                            ...
                            if (!Ua[c]) break;
                            if (Ga.test(c) !== m) break;
                            this.consume(), (h += Ua[c]);
                        }
                        var p = new Wa(h, this.settings).parse();
                        m
            ...
            parseGroup(e, t) {
                ...
                if ("{" === o || "\\begingroup" === o) {
                    ...
                    null ==
                    (a = this.parseFunction(t, e) || this.parseSymbol()) &&
                    "\\" === o[0] &&
                    !Va.hasOwnProperty(o)
                ) {
                    if (this.settings.throwOnError)
                        throw new n("Undefined control sequence: " + o, i);
                    (a = this.formatUnsupportedCmd(o)), this.consume();
                }
                return a;
            }
            formLigatures(e) {
        ...
        var $a = function (e, t, r) {
                ...
                var a = Ze.makeSpan(["katex-error"], [new Z(t)]);
                return (
                ...
                try {
                    return (function (e, t, r) {
                        var a,
                            n = Ht(r);
                        if ("mathml" === r.output)
                            return Rt(e, t, n, r.displayMode, !0);
                        if ("html" === r.output) {
                            var i = kt(e, n);
                            a = Ze.makeSpan(["katex"], [i]);
                        } else {
                            var o = Rt(e, t, n, r.displayMode, !1),
                                s = kt(e, n);
                            a = Ze.makeSpan(["katex"], [o, s]);
                        }
                        return Ot(a, r);
                    })(_a(e, r), e, r);
                } catch (t) {
